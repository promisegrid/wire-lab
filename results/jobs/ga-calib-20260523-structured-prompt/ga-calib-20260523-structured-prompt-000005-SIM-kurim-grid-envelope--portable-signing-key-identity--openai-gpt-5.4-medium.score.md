...
- Cell ID: `ga-calib-20260523-structured-prompt-000005-SIM-kurim-grid-envelope--portable-signing-key-identity--openai-gpt-5.4-medium`
- Simulation ID: `SIM-kurim-grid-envelope`
- Scenario ID: `portable-signing-key-identity`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-kurim-grid-envelope/portable-signing-key-identity/openai-gpt-5.4-medium/20260523-171656.json`
