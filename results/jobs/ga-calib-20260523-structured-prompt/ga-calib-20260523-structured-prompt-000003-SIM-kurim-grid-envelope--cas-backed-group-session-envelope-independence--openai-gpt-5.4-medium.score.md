...
- Cell ID: `ga-calib-20260523-structured-prompt-000003-SIM-kurim-grid-envelope--cas-backed-group-session-envelope-independence--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-kurim-grid-envelope/cas-backed-group-session-envelope-independence/openai-gpt-5.4-medium/20260523-171656.json`
