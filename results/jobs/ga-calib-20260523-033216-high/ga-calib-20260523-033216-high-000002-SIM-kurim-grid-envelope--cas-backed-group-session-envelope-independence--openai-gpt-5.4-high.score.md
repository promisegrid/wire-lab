...
- Run group ID: `ga-calib-20260523-033216-high`
- Cell ID: `ga-calib-20260523-033216-high-000002-SIM-kurim-grid-envelope--cas-backed-group-session-envelope-independence--openai-gpt-5.4-high`
- Simulation ID: `SIM-kurim-grid-envelope`
- Scenario ID: `cas-backed-group-session-envelope-independence`
- Model ID: `openai-gpt-5.4-high`
- Result path: `results/SIM-kurim-grid-envelope/cas-backed-group-session-envelope-independence/openai-gpt-5.4-high/20260523-033216.json`
