...
- Cell ID: `ga-calib-20260523-033216-high-000001-SIM-kurim-grid-envelope--bgp-class-routing-app-conflicting-policies--openai-gpt-5.4-high`
- Simulation ID: `SIM-kurim-grid-envelope`
- Scenario ID: `bgp-class-routing-app-conflicting-policies`
- Model ID: `openai-gpt-5.4-high`
- Result path: `results/SIM-kurim-grid-envelope/bgp-class-routing-app-conflicting-policies/openai-gpt-5.4-high/20260523-033216.json`
