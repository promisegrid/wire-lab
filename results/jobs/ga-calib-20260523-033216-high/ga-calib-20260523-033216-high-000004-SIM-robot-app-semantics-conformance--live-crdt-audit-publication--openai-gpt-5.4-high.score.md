...
- Cell ID: `ga-calib-20260523-033216-high-000004-SIM-robot-app-semantics-conformance--live-crdt-audit-publication--openai-gpt-5.4-high`
- Simulation ID: `SIM-robot-app-semantics-conformance`
- Scenario ID: `live-crdt-audit-publication`
- Model ID: `openai-gpt-5.4-high`
- Result path: `results/SIM-robot-app-semantics-conformance/live-crdt-audit-publication/openai-gpt-5.4-high/20260523-033216.json`
