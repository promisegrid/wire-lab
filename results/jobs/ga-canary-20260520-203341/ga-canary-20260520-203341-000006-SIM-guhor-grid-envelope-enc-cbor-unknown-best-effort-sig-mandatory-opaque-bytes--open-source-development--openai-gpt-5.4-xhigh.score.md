...
- Cell ID: `ga-canary-20260520-203341-000006-SIM-guhor-grid-envelope-enc-cbor-unknown-best-effort-sig-mandatory-opaque-bytes--open-source-development--openai-gpt-5.4-xhigh`
...
- Result path: `results/SIM-guhor-grid-envelope-enc-cbor-unknown-best-effort-sig-mandatory-opaque-bytes/open-source-development/openai-gpt-5.4-xhigh/20260520-203341.json`
