...
- Cell ID: `ga-canary-20260520-203341-000008-SIM-gazan-grid-envelope-enc-cbor-unknown-hard-reject-sig-unsigned-v0--chunking-identity-bakeoff-raw-only-migration--openai-gpt-5.4-xhigh`
...
- Result path: `results/SIM-gazan-grid-envelope-enc-cbor-unknown-hard-reject-sig-unsigned-v0/chunking-identity-bakeoff-raw-only-migration/openai-gpt-5.4-xhigh/20260520-203341.json`
