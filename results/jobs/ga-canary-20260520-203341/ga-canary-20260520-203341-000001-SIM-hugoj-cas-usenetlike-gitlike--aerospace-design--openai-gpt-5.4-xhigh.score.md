...
- Cell ID: `ga-canary-20260520-203341-000001-SIM-hugoj-cas-usenetlike-gitlike--aerospace-design--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-hugoj-cas-usenetlike-gitlike`
- Scenario ID: `aerospace-design`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-hugoj-cas-usenetlike-gitlike/aerospace-design/openai-gpt-5.4-xhigh/20260520-203341.json`
