...
- Cell ID: `ga-canary-20260520-203341-000009-SIM-gazan-grid-envelope-enc-cbor-unknown-hard-reject-sig-unsigned-v0--open-source-development--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-gazan-grid-envelope-enc-cbor-unknown-hard-reject-sig-unsigned-v0`
- Scenario ID: `open-source-development`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-gazan-grid-envelope-enc-cbor-unknown-hard-reject-sig-unsigned-v0/open-source-development/openai-gpt-5.4-xhigh/20260520-203341.json`
