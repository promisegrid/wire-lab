...
- Cell ID: `ga-calib-20260523-structured-strict-000001-SIM-kurim-grid-envelope--app-semantics-partial-conformance--openai-gpt-5.4-medium`
- Simulation ID: `SIM-kurim-grid-envelope`
- Scenario ID: `app-semantics-partial-conformance`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-kurim-grid-envelope/app-semantics-partial-conformance/openai-gpt-5.4-medium/20260523-171656.json`
