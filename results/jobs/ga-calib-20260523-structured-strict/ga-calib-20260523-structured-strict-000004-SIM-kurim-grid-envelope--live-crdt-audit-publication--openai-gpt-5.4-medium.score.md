...
- Cell ID: `ga-calib-20260523-structured-strict-000004-SIM-kurim-grid-envelope--live-crdt-audit-publication--openai-gpt-5.4-medium`
- Simulation ID: `SIM-kurim-grid-envelope`
- Scenario ID: `live-crdt-audit-publication`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-kurim-grid-envelope/live-crdt-audit-publication/openai-gpt-5.4-medium/20260523-171656.json`
