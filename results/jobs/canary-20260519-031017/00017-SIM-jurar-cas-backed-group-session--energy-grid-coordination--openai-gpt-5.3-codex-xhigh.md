...
- Intended result path: `results/SIM-jurar-cas-backed-group-session/energy-grid-coordination/openai-gpt-5.3-codex-xhigh/20260519-031715.md`
...
- `simulations/SIM-jurar-cas-backed-group-session/QUESTION.md` if present
- local draft specs under `simulations/SIM-jurar-cas-backed-group-session/` if present
- `scenarios/energy-grid-coordination/energy-grid-coordination.md`
...
`results/SIM-jurar-cas-backed-group-session/energy-grid-coordination/openai-gpt-5.3-codex-xhigh/20260519-031715.md`
