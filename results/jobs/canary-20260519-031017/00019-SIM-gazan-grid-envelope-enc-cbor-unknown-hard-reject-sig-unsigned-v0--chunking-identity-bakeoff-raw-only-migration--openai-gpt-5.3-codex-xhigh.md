...
- Intended result path: `results/SIM-gazan-grid-envelope-enc-cbor-unknown-hard-reject-sig-unsigned-v0/chunking-identity-bakeoff-raw-only-migration/openai-gpt-5.3-codex-xhigh/20260519-031715.md`
...
`results/SIM-gazan-grid-envelope-enc-cbor-unknown-hard-reject-sig-unsigned-v0/chunking-identity-bakeoff-raw-only-migration/openai-gpt-5.3-codex-xhigh/20260519-031715.md`
