...
- Intended result path: `results/SIM-jomag-cas-object-model/decentralized-supply-chain/openai-gpt-5.3-codex-xhigh/20260519-031715.md`
...
- `simulations/SIM-jomag-cas-object-model/QUESTION.md` if present
- local draft specs under `simulations/SIM-jomag-cas-object-model/` if present
- `scenarios/decentralized-supply-chain/decentralized-supply-chain.md`
...
`results/SIM-jomag-cas-object-model/decentralized-supply-chain/openai-gpt-5.3-codex-xhigh/20260519-031715.md`
