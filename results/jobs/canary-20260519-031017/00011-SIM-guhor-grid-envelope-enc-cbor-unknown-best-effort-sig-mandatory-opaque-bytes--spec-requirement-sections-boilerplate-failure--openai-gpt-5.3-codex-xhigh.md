...
- Intended result path: `results/SIM-guhor-grid-envelope-enc-cbor-unknown-best-effort-sig-mandatory-opaque-bytes/spec-requirement-sections-boilerplate-failure/openai-gpt-5.3-codex-xhigh/20260519-031715.md`
...
- `scenarios/spec-requirement-sections-boilerplate-failure/spec-requirement-sections-boilerplate-failure.md`
...
`results/SIM-guhor-grid-envelope-enc-cbor-unknown-best-effort-sig-mandatory-opaque-bytes/spec-requirement-sections-boilerplate-failure/openai-gpt-5.3-codex-xhigh/20260519-031715.md`
