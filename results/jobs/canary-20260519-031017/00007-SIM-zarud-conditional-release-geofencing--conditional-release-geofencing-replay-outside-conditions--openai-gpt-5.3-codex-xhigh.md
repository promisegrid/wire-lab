...
- Intended result path: `results/SIM-zarud-conditional-release-geofencing/conditional-release-geofencing-replay-outside-conditions/openai-gpt-5.3-codex-xhigh/20260519-031715.md`

## Required Source Inputs

Read only source/design inputs before producing the verdict:

- `simulations/SIM-zarud-conditional-release-geofencing/README.md`
- `simulations/SIM-zarud-conditional-release-geofencing/QUESTION.md` if present
- local draft specs under `simulations/SIM-zarud-conditional-release-geofencing/` if present
...
`results/SIM-zarud-conditional-release-geofencing/conditional-release-geofencing-replay-outside-conditions/openai-gpt-5.3-codex-xhigh/20260519-031715.md`
