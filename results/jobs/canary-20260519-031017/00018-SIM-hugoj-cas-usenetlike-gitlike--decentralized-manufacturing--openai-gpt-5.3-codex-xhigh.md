...
- Intended result path: `results/SIM-hugoj-cas-usenetlike-gitlike/decentralized-manufacturing/openai-gpt-5.3-codex-xhigh/20260519-031715.md`
...
- `simulations/SIM-hugoj-cas-usenetlike-gitlike/QUESTION.md` if present
- local draft specs under `simulations/SIM-hugoj-cas-usenetlike-gitlike/` if present
- `scenarios/decentralized-manufacturing/decentralized-manufacturing.md`
...
`results/SIM-hugoj-cas-usenetlike-gitlike/decentralized-manufacturing/openai-gpt-5.3-codex-xhigh/20260519-031715.md`
