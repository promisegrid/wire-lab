...
- Cell ID: `ga-backfill-20260523-031435-000014-SIM-kurim-grid-envelope--udp-feed-v0-conformance-malformed-datagram--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-kurim-grid-envelope`
- Scenario ID: `udp-feed-v0-conformance-malformed-datagram`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-kurim-grid-envelope/udp-feed-v0-conformance-malformed-datagram/openai-gpt-5.4-xhigh/20260523-031435.json`
