...
- Cell ID: `ga-backfill-20260523-031435-000004-SIM-kurim-grid-envelope--bgp-class-routing-app-sparse-knowledge--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-kurim-grid-envelope`
- Scenario ID: `bgp-class-routing-app-sparse-knowledge`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-kurim-grid-envelope/bgp-class-routing-app-sparse-knowledge/openai-gpt-5.4-xhigh/20260523-031435.json`
