...
- Cell ID: `ga-backfill-20260523-031435-000026-SIM-robot-app-semantics-conformance--live-crdt-audit-publication--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-robot-app-semantics-conformance`
- Scenario ID: `live-crdt-audit-publication`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-robot-app-semantics-conformance/live-crdt-audit-publication/openai-gpt-5.4-xhigh/20260523-031435.json`
