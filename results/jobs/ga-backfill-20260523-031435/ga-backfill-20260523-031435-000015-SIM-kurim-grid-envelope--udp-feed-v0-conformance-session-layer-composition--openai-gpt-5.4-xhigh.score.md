...
- Cell ID: `ga-backfill-20260523-031435-000015-SIM-kurim-grid-envelope--udp-feed-v0-conformance-session-layer-composition--openai-gpt-5.4-xhigh`
...
- Result path: `results/SIM-kurim-grid-envelope/udp-feed-v0-conformance-session-layer-composition/openai-gpt-5.4-xhigh/20260523-031435.json`
