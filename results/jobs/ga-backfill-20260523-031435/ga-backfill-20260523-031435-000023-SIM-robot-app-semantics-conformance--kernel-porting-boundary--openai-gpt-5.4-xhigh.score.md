...
- Cell ID: `ga-backfill-20260523-031435-000023-SIM-robot-app-semantics-conformance--kernel-porting-boundary--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-robot-app-semantics-conformance`
- Scenario ID: `kernel-porting-boundary`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-robot-app-semantics-conformance/kernel-porting-boundary/openai-gpt-5.4-xhigh/20260523-031435.json`
