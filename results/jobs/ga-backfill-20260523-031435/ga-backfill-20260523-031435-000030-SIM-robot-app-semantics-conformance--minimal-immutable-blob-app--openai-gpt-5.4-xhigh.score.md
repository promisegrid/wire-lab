...
- Cell ID: `ga-backfill-20260523-031435-000030-SIM-robot-app-semantics-conformance--minimal-immutable-blob-app--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-robot-app-semantics-conformance`
- Scenario ID: `minimal-immutable-blob-app`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-robot-app-semantics-conformance/minimal-immutable-blob-app/openai-gpt-5.4-xhigh/20260523-031435.json`
