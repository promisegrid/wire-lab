...
Choose a descriptive `child_id` that starts with `SIM-hadit-child-` and ends with a kebab-case design slug. Do not use generic `ga-child`, `pending`, or ordinal-only names.
...
- Planned child ID prefix: `SIM-hadit-child-`
- Temporary child ID: `SIM-hadit-child-pending-0002`
- Temporary child path: `proposals/ga-canary-20260524-dalor-pobod-forced/simulations/SIM-hadit-child-pending-0002/`
- Operation: `breed`
- Parent IDs: `SIM-dalor-grid-envelope-protocol-owned-signature-slot, SIM-pobod-grid-envelope-outer-promise-nested-signed-payload`
...
{"child_id":"SIM-hadit-child-descriptive-design-slug","design_delta_summary":"one to three bounded design deltas","files":[{"path":"README.md","content":"# ..."},{"path":"QUESTION.md","content":"# ..."}]}
