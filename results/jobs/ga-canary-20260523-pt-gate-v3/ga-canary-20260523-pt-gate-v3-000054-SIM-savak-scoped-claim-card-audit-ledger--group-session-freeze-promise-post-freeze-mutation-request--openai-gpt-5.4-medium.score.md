...
- Cell ID: `ga-canary-20260523-pt-gate-v3-000054-SIM-savak-scoped-claim-card-audit-ledger--group-session-freeze-promise-post-freeze-mutation-request--openai-gpt-5.4-medium`
- Simulation ID: `SIM-savak-scoped-claim-card-audit-ledger`
- Scenario ID: `group-session-freeze-promise-post-freeze-mutation-request`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-savak-scoped-claim-card-audit-ledger/group-session-freeze-promise-post-freeze-mutation-request/openai-gpt-5.4-medium/20260524-024852.json`
...
### `simulations/SIM-savak-scoped-claim-card-audit-ledger/README.md`
...
### `simulations/SIM-savak-scoped-claim-card-audit-ledger/QUESTION.md`
...
### `simulations/SIM-savak-scoped-claim-card-audit-ledger/PATTERNS.md`
