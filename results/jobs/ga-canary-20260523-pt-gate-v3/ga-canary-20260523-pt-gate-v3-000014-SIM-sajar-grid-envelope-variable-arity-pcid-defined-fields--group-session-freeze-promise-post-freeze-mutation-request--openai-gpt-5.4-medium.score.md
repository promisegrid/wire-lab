...
- Cell ID: `ga-canary-20260523-pt-gate-v3-000014-SIM-sajar-grid-envelope-variable-arity-pcid-defined-fields--group-session-freeze-promise-post-freeze-mutation-request--openai-gpt-5.4-medium`
- Simulation ID: `SIM-sajar-grid-envelope-variable-arity-pcid-defined-fields`
- Scenario ID: `group-session-freeze-promise-post-freeze-mutation-request`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-sajar-grid-envelope-variable-arity-pcid-defined-fields/group-session-freeze-promise-post-freeze-mutation-request/openai-gpt-5.4-medium/20260524-024852.json`
