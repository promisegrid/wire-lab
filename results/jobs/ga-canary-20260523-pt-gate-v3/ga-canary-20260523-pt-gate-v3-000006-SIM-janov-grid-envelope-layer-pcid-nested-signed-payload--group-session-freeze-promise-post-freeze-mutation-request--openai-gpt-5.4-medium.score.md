...
- Cell ID: `ga-canary-20260523-pt-gate-v3-000006-SIM-janov-grid-envelope-layer-pcid-nested-signed-payload--group-session-freeze-promise-post-freeze-mutation-request--openai-gpt-5.4-medium`
- Simulation ID: `SIM-janov-grid-envelope-layer-pcid-nested-signed-payload`
- Scenario ID: `group-session-freeze-promise-post-freeze-mutation-request`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-janov-grid-envelope-layer-pcid-nested-signed-payload/group-session-freeze-promise-post-freeze-mutation-request/openai-gpt-5.4-medium/20260524-024852.json`
