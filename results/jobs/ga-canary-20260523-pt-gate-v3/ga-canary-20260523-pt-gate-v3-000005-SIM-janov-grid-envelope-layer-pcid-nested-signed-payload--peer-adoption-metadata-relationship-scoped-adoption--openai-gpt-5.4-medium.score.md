...
- Cell ID: `ga-canary-20260523-pt-gate-v3-000005-SIM-janov-grid-envelope-layer-pcid-nested-signed-payload--peer-adoption-metadata-relationship-scoped-adoption--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-janov-grid-envelope-layer-pcid-nested-signed-payload/peer-adoption-metadata-relationship-scoped-adoption/openai-gpt-5.4-medium/20260524-024852.json`
