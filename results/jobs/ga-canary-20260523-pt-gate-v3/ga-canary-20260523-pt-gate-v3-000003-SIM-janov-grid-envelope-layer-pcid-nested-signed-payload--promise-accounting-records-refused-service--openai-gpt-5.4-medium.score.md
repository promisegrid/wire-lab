...
- Cell ID: `ga-canary-20260523-pt-gate-v3-000003-SIM-janov-grid-envelope-layer-pcid-nested-signed-payload--promise-accounting-records-refused-service--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-janov-grid-envelope-layer-pcid-nested-signed-payload/promise-accounting-records-refused-service/openai-gpt-5.4-medium/20260524-024852.json`
