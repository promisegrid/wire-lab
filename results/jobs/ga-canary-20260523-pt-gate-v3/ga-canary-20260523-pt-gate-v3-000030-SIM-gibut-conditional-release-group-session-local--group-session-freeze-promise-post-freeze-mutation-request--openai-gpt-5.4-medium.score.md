...
- Cell ID: `ga-canary-20260523-pt-gate-v3-000030-SIM-gibut-conditional-release-group-session-local--group-session-freeze-promise-post-freeze-mutation-request--openai-gpt-5.4-medium`
- Simulation ID: `SIM-gibut-conditional-release-group-session-local`
- Scenario ID: `group-session-freeze-promise-post-freeze-mutation-request`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-gibut-conditional-release-group-session-local/group-session-freeze-promise-post-freeze-mutation-request/openai-gpt-5.4-medium/20260524-024852.json`
