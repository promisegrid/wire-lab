...
- Cell ID: `ga-canary-20260523-pt-gate-v3-000032-SIM-gibut-conditional-release-group-session-local--promise-economy-spectrum-permissioned-capability-token--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-gibut-conditional-release-group-session-local/promise-economy-spectrum-permissioned-capability-token/openai-gpt-5.4-medium/20260524-024852.json`
