...
- Cell ID: `ga-canary-20260523-pt-gate-v3-000017-SIM-gadol-peer-adoption-promise-message--promise-economy-spectrum-peer-local-assessment-only--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-gadol-peer-adoption-promise-message/promise-economy-spectrum-peer-local-assessment-only/openai-gpt-5.4-medium/20260524-024852.json`
