...
- Cell ID: `ga-canary-20260523-pt-gate-v3-000009-SIM-sajar-grid-envelope-variable-arity-pcid-defined-fields--promise-economy-spectrum-peer-local-assessment-only--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-sajar-grid-envelope-variable-arity-pcid-defined-fields/promise-economy-spectrum-peer-local-assessment-only/openai-gpt-5.4-medium/20260524-024852.json`
