...
- Cell ID: `ga-canary-20260520-215120-000004-SIM-vutar-grid-envelope-enc-cbor-unknown-opaque-sig-mandatory-opaque-bytes--conditional-release-geofencing-geofenced-group-dispatch--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-vutar-grid-envelope-enc-cbor-unknown-opaque-sig-mandatory-opaque-bytes`
- Scenario ID: `conditional-release-geofencing-geofenced-group-dispatch`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-vutar-grid-envelope-enc-cbor-unknown-opaque-sig-mandatory-opaque-bytes/conditional-release-geofencing-geofenced-group-dispatch/openai-gpt-5.4-xhigh/20260520-215120.json`
