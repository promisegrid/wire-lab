...
- Cell ID: `ga-canary-20260520-215120-000006-SIM-vutar-grid-envelope-enc-cbor-unknown-opaque-sig-mandatory-opaque-bytes--bgp-class-routing-app-route-hijack--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-vutar-grid-envelope-enc-cbor-unknown-opaque-sig-mandatory-opaque-bytes`
- Scenario ID: `bgp-class-routing-app-route-hijack`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-vutar-grid-envelope-enc-cbor-unknown-opaque-sig-mandatory-opaque-bytes/bgp-class-routing-app-route-hijack/openai-gpt-5.4-xhigh/20260520-215120.json`
