...
- Run group ID: `ga-calib-20260523-033216-medium`
- Cell ID: `ga-calib-20260523-033216-medium-000002-SIM-kurim-grid-envelope--cas-backed-group-session-envelope-independence--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-kurim-grid-envelope/cas-backed-group-session-envelope-independence/openai-gpt-5.4-medium/20260523-033216.json`
