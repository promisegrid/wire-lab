...
- Cell ID: `ga-canary-20260521-003110-000013-SIM-maraz-child-signed-summary-header-nested-schema--chunk-feed-replication-sparse-advertisement--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-maraz-child-signed-summary-header-nested-schema`
- Scenario ID: `chunk-feed-replication-sparse-advertisement`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `proposals/ga-canary-20260521-003110/results/SIM-maraz-child-signed-summary-header-nested-schema/chunk-feed-replication-sparse-advertisement/openai-gpt-5.4-xhigh/20260521-003110.json`
...
### `proposals/ga-canary-20260521-003110/simulations/SIM-maraz-child-signed-summary-header-nested-schema/README.md`

```markdown
# SIM-maraz-child-signed-summary-header-nested-schema: Grid-envelope signed summary header probe

This child breeds `SIM-janov-grid-envelope-layer-pcid-nested-signed-payload` and `SIM-sajar-grid-envelope-variable-arity-pcid-defined-fields`.
...
### `proposals/ga-canary-20260521-003110/simulations/SIM-maraz-child-signed-summary-header-nested-schema/QUESTION.md`

```markdown
# Question

Can a grid envelope improve sparse-knowledge interoperability by fixing a small signed outer summary header while leaving the detailed inner payload pCID-defined and optionally variable-arity, or does required header projection become too lossy, duplicative, or fragile for long-term audit? Source: bred from `DI-joman` parent probes.
```

### `proposals/ga-canary-20260521-003110/simulations/SIM-maraz-child-signed-summary-header-nested-schema/protocols/grid-envelope.d/CHANGELOG.md`
...
- Initial child draft created from `SIM-janov-grid-envelope-layer-pcid-nested-signed-payload` and `SIM-sajar-grid-envelope-variable-arity-pcid-defined-fields`.
...
### `proposals/ga-canary-20260521-003110/simulations/SIM-maraz-child-signed-summary-header-nested-schema/protocols/grid-envelope.d/specs/grid-envelope-draft.md`
...
This spec defines one grid-envelope candidate for wire-lab comparison. It is a specimen inside `SIM-maraz-child-signed-summary-header-nested-schema`, not a harness rule and not the canonical PromiseGrid envelope.

This child combines two parent moves:
...
The parent variable-arity design made too much evidence invisible to generic peers. This child requires every sender to project a minimal stable summary into `summary_refs` so routing, replication, and later audit can still refer to durable objects even when `pcid_b` is unknown.
...
This child separates two claims:
