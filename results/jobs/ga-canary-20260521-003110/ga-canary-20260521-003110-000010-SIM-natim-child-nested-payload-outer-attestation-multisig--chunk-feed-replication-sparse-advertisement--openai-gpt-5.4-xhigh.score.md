...
- Cell ID: `ga-canary-20260521-003110-000010-SIM-natim-child-nested-payload-outer-attestation-multisig--chunk-feed-replication-sparse-advertisement--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-natim-child-nested-payload-outer-attestation-multisig`
- Scenario ID: `chunk-feed-replication-sparse-advertisement`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `proposals/ga-canary-20260521-003110/results/SIM-natim-child-nested-payload-outer-attestation-multisig/chunk-feed-replication-sparse-advertisement/openai-gpt-5.4-xhigh/20260521-003110.json`
...
### `proposals/ga-canary-20260521-003110/simulations/SIM-natim-child-nested-payload-outer-attestation-multisig/README.md`

```markdown
# SIM-natim-child-nested-payload-outer-attestation-multisig: Nested payload with outer attestation Multisig probe

This child simulation breeds two parent ideas into one bounded specimen:
...
Both parents were penalized because they were strong envelope/proof specimens but weak at durable attribution of the current actor's promise. This child repairs that specific weakness while keeping the design standalone, auditable, and still payload-extensible.
...
### `proposals/ga-canary-20260521-003110/simulations/SIM-natim-child-nested-payload-outer-attestation-multisig/QUESTION.md`
...
### `proposals/ga-canary-20260521-003110/simulations/SIM-natim-child-nested-payload-outer-attestation-multisig/protocols/grid-envelope.d/CHANGELOG.md`
...
This protocol tree is a simulation-local child specimen derived from `DI-joman` and `DI-sahiv`.
```

### `proposals/ga-canary-20260521-003110/simulations/SIM-natim-child-nested-payload-outer-attestation-multisig/protocols/grid-envelope.d/specs/grid-envelope-draft.md`
...
This spec defines one grid-envelope candidate for wire-lab comparison. It is a specimen inside `SIM-natim-child-nested-payload-outer-attestation-multisig`, not a harness rule and not the canonical PromiseGrid envelope.

The child combines two parent strengths while making one explicit repair:
...
This child therefore separates two promises:
...
This child introduces explicit audit outcomes:
