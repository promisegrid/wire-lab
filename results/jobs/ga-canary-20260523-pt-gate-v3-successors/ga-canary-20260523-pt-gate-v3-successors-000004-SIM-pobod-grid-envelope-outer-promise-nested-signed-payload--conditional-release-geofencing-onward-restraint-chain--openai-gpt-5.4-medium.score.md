...
- Cell ID: `ga-canary-20260523-pt-gate-v3-successors-000004-SIM-pobod-grid-envelope-outer-promise-nested-signed-payload--conditional-release-geofencing-onward-restraint-chain--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-pobod-grid-envelope-outer-promise-nested-signed-payload/conditional-release-geofencing-onward-restraint-chain/openai-gpt-5.4-medium/20260524-032521.json`
