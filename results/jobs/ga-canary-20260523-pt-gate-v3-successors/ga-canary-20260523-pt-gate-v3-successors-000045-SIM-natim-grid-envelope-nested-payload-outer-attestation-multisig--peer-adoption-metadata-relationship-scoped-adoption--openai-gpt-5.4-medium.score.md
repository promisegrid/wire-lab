...
- Cell ID: `ga-canary-20260523-pt-gate-v3-successors-000045-SIM-natim-grid-envelope-nested-payload-outer-attestation-multisig--peer-adoption-metadata-relationship-scoped-adoption--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-natim-grid-envelope-nested-payload-outer-attestation-multisig/peer-adoption-metadata-relationship-scoped-adoption/openai-gpt-5.4-medium/20260524-032521.json`
