...
- Cell ID: `ga-canary-20260523-pt-gate-v3-successors-000038-SIM-padin-group-session-freeze-evidence--group-session-freeze-promise-post-freeze-mutation-request--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-padin-group-session-freeze-evidence/group-session-freeze-promise-post-freeze-mutation-request/openai-gpt-5.4-medium/20260524-032521.json`
