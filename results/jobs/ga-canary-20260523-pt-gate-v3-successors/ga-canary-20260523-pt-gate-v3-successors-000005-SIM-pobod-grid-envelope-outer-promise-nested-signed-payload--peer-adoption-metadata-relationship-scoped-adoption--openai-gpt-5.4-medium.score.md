...
- Cell ID: `ga-canary-20260523-pt-gate-v3-successors-000005-SIM-pobod-grid-envelope-outer-promise-nested-signed-payload--peer-adoption-metadata-relationship-scoped-adoption--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-pobod-grid-envelope-outer-promise-nested-signed-payload/peer-adoption-metadata-relationship-scoped-adoption/openai-gpt-5.4-medium/20260524-032521.json`
