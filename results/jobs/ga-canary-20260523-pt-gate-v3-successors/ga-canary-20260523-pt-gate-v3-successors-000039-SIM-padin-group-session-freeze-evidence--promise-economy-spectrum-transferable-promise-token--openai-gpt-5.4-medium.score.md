...
- Cell ID: `ga-canary-20260523-pt-gate-v3-successors-000039-SIM-padin-group-session-freeze-evidence--promise-economy-spectrum-transferable-promise-token--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-padin-group-session-freeze-evidence/promise-economy-spectrum-transferable-promise-token/openai-gpt-5.4-medium/20260524-032521.json`
