...
- Cell ID: `ga-canary-20260523-pt-gate-v3-successors-000057-SIM-konit-pcid-promise-evidence-index--promise-economy-spectrum-peer-local-assessment-only--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-konit-pcid-promise-evidence-index/promise-economy-spectrum-peer-local-assessment-only/openai-gpt-5.4-medium/20260524-032521.json`
