...
- Cell ID: `ga-canary-20260523-pt-gate-v3-successors-000013-SIM-dutam-grid-envelope-fixed-header-variable-body--peer-adoption-metadata-relationship-scoped-adoption--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-dutam-grid-envelope-fixed-header-variable-body/peer-adoption-metadata-relationship-scoped-adoption/openai-gpt-5.4-medium/20260524-032521.json`
