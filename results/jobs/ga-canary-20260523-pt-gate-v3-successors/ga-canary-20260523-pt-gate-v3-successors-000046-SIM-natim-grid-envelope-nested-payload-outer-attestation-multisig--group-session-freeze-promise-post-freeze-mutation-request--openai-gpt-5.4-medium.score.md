...
- Run group ID: `ga-canary-20260523-pt-gate-v3-successors`
- Cell ID: `ga-canary-20260523-pt-gate-v3-successors-000046-SIM-natim-grid-envelope-nested-payload-outer-attestation-multisig--group-session-freeze-promise-post-freeze-mutation-request--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-natim-grid-envelope-nested-payload-outer-attestation-multisig/group-session-freeze-promise-post-freeze-mutation-request/openai-gpt-5.4-medium/20260524-032521.json`
