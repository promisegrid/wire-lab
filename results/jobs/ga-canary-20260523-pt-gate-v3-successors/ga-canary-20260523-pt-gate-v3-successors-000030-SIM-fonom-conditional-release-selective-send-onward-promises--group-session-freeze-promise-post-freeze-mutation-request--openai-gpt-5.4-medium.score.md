...
- Cell ID: `ga-canary-20260523-pt-gate-v3-successors-000030-SIM-fonom-conditional-release-selective-send-onward-promises--group-session-freeze-promise-post-freeze-mutation-request--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-fonom-conditional-release-selective-send-onward-promises/group-session-freeze-promise-post-freeze-mutation-request/openai-gpt-5.4-medium/20260524-032521.json`
