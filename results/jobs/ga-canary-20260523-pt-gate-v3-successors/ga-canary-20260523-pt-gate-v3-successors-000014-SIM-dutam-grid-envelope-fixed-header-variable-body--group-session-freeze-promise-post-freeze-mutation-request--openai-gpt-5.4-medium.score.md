...
- Cell ID: `ga-canary-20260523-pt-gate-v3-successors-000014-SIM-dutam-grid-envelope-fixed-header-variable-body--group-session-freeze-promise-post-freeze-mutation-request--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-dutam-grid-envelope-fixed-header-variable-body/group-session-freeze-promise-post-freeze-mutation-request/openai-gpt-5.4-medium/20260524-032521.json`
