...
- Cell ID: `ga-rescore-20260526-012535-goban-dalor-fovip-v4-000006-SIM-dalor-grid-envelope-protocol-owned-signature-slot--kernel-porting-boundary--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-dalor-grid-envelope-protocol-owned-signature-slot/kernel-porting-boundary/openai-gpt-5.4-medium/20260526-012535.json`
