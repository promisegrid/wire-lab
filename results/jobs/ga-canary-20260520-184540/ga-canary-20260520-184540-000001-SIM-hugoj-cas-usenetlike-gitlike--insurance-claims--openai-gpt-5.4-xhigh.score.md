...
- Cell ID: `ga-canary-20260520-184540-000001-SIM-hugoj-cas-usenetlike-gitlike--insurance-claims--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-hugoj-cas-usenetlike-gitlike`
- Scenario ID: `insurance-claims`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-hugoj-cas-usenetlike-gitlike/insurance-claims/openai-gpt-5.4-xhigh/20260520-184540.json`
