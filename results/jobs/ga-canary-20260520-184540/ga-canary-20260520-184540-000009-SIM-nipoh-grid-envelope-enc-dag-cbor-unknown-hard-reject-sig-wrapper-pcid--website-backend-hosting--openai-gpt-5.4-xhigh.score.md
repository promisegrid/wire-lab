...
- Cell ID: `ga-canary-20260520-184540-000009-SIM-nipoh-grid-envelope-enc-dag-cbor-unknown-hard-reject-sig-wrapper-pcid--website-backend-hosting--openai-gpt-5.4-xhigh`
...
- Result path: `results/SIM-nipoh-grid-envelope-enc-dag-cbor-unknown-hard-reject-sig-wrapper-pcid/website-backend-hosting/openai-gpt-5.4-xhigh/20260520-184540.json`
