...
- Cell ID: `ga-canary-20260520-184540-000005-SIM-jokak-grid-envelope-enc-cbor-unknown-best-effort-sig-mandatory-sig-pcid-payload--state-governance--openai-gpt-5.4-xhigh`
...
- Result path: `results/SIM-jokak-grid-envelope-enc-cbor-unknown-best-effort-sig-mandatory-sig-pcid-payload/state-governance/openai-gpt-5.4-xhigh/20260520-184540.json`
