...
- Cell ID: `ga-backfill-20260522-215638-medium-000013-SIM-kurim-grid-envelope--transport-family-bakeoff-per-hop-authorization-failure--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-kurim-grid-envelope/transport-family-bakeoff-per-hop-authorization-failure/openai-gpt-5.4-medium/20260523-045646.json`
