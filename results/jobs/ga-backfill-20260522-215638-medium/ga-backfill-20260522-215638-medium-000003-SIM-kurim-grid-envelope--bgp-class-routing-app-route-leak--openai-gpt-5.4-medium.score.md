...
- Cell ID: `ga-backfill-20260522-215638-medium-000003-SIM-kurim-grid-envelope--bgp-class-routing-app-route-leak--openai-gpt-5.4-medium`
- Simulation ID: `SIM-kurim-grid-envelope`
- Scenario ID: `bgp-class-routing-app-route-leak`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-kurim-grid-envelope/bgp-class-routing-app-route-leak/openai-gpt-5.4-medium/20260523-045646.json`
