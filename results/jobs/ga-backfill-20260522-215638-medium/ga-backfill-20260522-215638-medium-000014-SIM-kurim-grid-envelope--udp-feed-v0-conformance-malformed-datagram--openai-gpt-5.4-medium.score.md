...
- Cell ID: `ga-backfill-20260522-215638-medium-000014-SIM-kurim-grid-envelope--udp-feed-v0-conformance-malformed-datagram--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-kurim-grid-envelope/udp-feed-v0-conformance-malformed-datagram/openai-gpt-5.4-medium/20260523-045646.json`
