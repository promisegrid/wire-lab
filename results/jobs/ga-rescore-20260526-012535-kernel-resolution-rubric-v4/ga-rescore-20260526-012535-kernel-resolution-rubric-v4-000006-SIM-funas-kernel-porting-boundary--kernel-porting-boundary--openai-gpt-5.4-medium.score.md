...
- Cell ID: `ga-rescore-20260526-012535-kernel-resolution-rubric-v4-000006-SIM-funas-kernel-porting-boundary--kernel-porting-boundary--openai-gpt-5.4-medium`
- Simulation ID: `SIM-funas-kernel-porting-boundary`
- Scenario ID: `kernel-porting-boundary`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-funas-kernel-porting-boundary/kernel-porting-boundary/openai-gpt-5.4-medium/20260526-012535.json`
