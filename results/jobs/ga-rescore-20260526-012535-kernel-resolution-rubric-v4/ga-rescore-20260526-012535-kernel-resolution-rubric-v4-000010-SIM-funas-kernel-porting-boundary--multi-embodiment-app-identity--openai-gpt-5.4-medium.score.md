...
- Cell ID: `ga-rescore-20260526-012535-kernel-resolution-rubric-v4-000010-SIM-funas-kernel-porting-boundary--multi-embodiment-app-identity--openai-gpt-5.4-medium`
- Simulation ID: `SIM-funas-kernel-porting-boundary`
- Scenario ID: `multi-embodiment-app-identity`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-funas-kernel-porting-boundary/multi-embodiment-app-identity/openai-gpt-5.4-medium/20260526-012535.json`
