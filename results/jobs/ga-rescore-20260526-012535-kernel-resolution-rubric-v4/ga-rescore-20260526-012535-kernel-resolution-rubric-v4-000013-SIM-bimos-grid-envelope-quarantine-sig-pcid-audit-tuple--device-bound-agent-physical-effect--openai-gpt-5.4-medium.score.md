...
- Cell ID: `ga-rescore-20260526-012535-kernel-resolution-rubric-v4-000013-SIM-bimos-grid-envelope-quarantine-sig-pcid-audit-tuple--device-bound-agent-physical-effect--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-bimos-grid-envelope-quarantine-sig-pcid-audit-tuple/device-bound-agent-physical-effect/openai-gpt-5.4-medium/20260526-012535.json`
