...
- Run group ID: `ga-rescore-20260526-012535-kernel-resolution-rubric-v4`
- Cell ID: `ga-rescore-20260526-012535-kernel-resolution-rubric-v4-000008-SIM-funas-kernel-porting-boundary--device-bound-agent-physical-effect--openai-gpt-5.4-medium`
- Simulation ID: `SIM-funas-kernel-porting-boundary`
- Scenario ID: `device-bound-agent-physical-effect`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-funas-kernel-porting-boundary/device-bound-agent-physical-effect/openai-gpt-5.4-medium/20260526-012535.json`
