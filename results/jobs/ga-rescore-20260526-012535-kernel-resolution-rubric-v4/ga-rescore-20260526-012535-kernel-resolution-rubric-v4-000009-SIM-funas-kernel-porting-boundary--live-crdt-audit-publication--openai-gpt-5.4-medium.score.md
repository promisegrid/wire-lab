...
- Cell ID: `ga-rescore-20260526-012535-kernel-resolution-rubric-v4-000009-SIM-funas-kernel-porting-boundary--live-crdt-audit-publication--openai-gpt-5.4-medium`
- Simulation ID: `SIM-funas-kernel-porting-boundary`
- Scenario ID: `live-crdt-audit-publication`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-funas-kernel-porting-boundary/live-crdt-audit-publication/openai-gpt-5.4-medium/20260526-012535.json`
