...
- Cell ID: `ga-rescore-20260526-012535-kernel-resolution-rubric-v4-000003-SIM-fovip-kernel-promise-boundary-port-contract--device-bound-agent-physical-effect--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-fovip-kernel-promise-boundary-port-contract/device-bound-agent-physical-effect/openai-gpt-5.4-medium/20260526-012535.json`
