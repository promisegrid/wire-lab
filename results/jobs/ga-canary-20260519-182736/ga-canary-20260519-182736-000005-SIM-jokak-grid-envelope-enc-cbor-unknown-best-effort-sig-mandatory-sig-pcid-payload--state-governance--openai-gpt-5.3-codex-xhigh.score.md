...
- Cell ID: `ga-canary-20260519-182736-000005-SIM-jokak-grid-envelope-enc-cbor-unknown-best-effort-sig-mandatory-sig-pcid-payload--state-governance--openai-gpt-5.3-codex-xhigh`
- Simulation ID: `SIM-jokak-grid-envelope-enc-cbor-unknown-best-effort-sig-mandatory-sig-pcid-payload`
- Scenario ID: `state-governance`
- Model ID: `openai-gpt-5.3-codex-xhigh`
- Result path: `results/SIM-jokak-grid-envelope-enc-cbor-unknown-best-effort-sig-mandatory-sig-pcid-payload/state-governance/openai-gpt-5.3-codex-xhigh/20260519-182736.json`
