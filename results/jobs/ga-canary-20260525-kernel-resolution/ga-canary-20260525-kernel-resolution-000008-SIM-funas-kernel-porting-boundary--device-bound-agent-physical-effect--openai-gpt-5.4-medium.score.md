...
- Cell ID: `ga-canary-20260525-kernel-resolution-000008-SIM-funas-kernel-porting-boundary--device-bound-agent-physical-effect--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-funas-kernel-porting-boundary/device-bound-agent-physical-effect/openai-gpt-5.4-medium/20260525-203836.json`
