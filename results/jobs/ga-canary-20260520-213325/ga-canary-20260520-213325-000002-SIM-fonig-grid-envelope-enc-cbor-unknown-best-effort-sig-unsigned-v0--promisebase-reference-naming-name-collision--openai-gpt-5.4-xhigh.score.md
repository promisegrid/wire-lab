...
- Cell ID: `ga-canary-20260520-213325-000002-SIM-fonig-grid-envelope-enc-cbor-unknown-best-effort-sig-unsigned-v0--promisebase-reference-naming-name-collision--openai-gpt-5.4-xhigh`
...
- Result path: `results/SIM-fonig-grid-envelope-enc-cbor-unknown-best-effort-sig-unsigned-v0/promisebase-reference-naming-name-collision/openai-gpt-5.4-xhigh/20260520-213325.json`
...
### `scenarios/promisebase-reference-naming-name-collision/promisebase-reference-naming-name-collision.md`
