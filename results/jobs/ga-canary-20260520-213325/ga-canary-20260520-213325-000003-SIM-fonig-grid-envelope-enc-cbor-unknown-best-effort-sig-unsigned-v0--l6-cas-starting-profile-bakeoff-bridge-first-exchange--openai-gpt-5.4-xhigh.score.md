...
- Run group ID: `ga-canary-20260520-213325`
- Cell ID: `ga-canary-20260520-213325-000003-SIM-fonig-grid-envelope-enc-cbor-unknown-best-effort-sig-unsigned-v0--l6-cas-starting-profile-bakeoff-bridge-first-exchange--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-fonig-grid-envelope-enc-cbor-unknown-best-effort-sig-unsigned-v0`
- Scenario ID: `l6-cas-starting-profile-bakeoff-bridge-first-exchange`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-fonig-grid-envelope-enc-cbor-unknown-best-effort-sig-unsigned-v0/l6-cas-starting-profile-bakeoff-bridge-first-exchange/openai-gpt-5.4-xhigh/20260520-213325.json`
...
```markdown
# SIM-fonig-grid-envelope-enc-cbor-unknown-best-effort-sig-unsigned-v0: Grid-envelope variant

This simulation is a standalone positional grid-envelope specimen. It tests the
combination `enc-cbor`, `unknown-best-effort`, and `sig-unsigned-v0` without claiming
...
> Variant: `enc-cbor` / `unknown-best-effort` / `sig-unsigned-v0`.
> Source: `DI-fanah`.

## Purpose

This spec defines one full positional grid-envelope candidate for wire-lab
comparison. It is a specimen inside `SIM-fonig-grid-envelope-enc-cbor-unknown-best-effort-sig-unsigned-v0`, not a harness rule and not the
...
### `scenarios/l6-cas-starting-profile-bakeoff-bridge-first-exchange/l6-cas-starting-profile-bakeoff-bridge-first-exchange.md`

```markdown
# Bridge-first exchange

## Scenario ID

l6-cas-starting-profile-bakeoff-bridge-first-exchange
...
- Source row/title: Bridge-first exchange
...
Alice stores a pointer object and Bob tries to inspect it with IPFS / IPLD-shaped tooling.

## Stimulus

Run the candidate simulation against this source test: Whether DAG-CBOR-compatible bytes, CIDv1 values, and multicodec conventions make useful interop possible without importing a full external stack.

## Expected Pressure

If bridgeability removes ambiguity cheaply, the IPFS / IPLD-aligned profile becomes a stronger starting point.
```
