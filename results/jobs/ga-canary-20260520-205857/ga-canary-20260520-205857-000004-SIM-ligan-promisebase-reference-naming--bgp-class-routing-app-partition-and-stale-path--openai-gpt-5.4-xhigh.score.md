...
- Cell ID: `ga-canary-20260520-205857-000004-SIM-ligan-promisebase-reference-naming--bgp-class-routing-app-partition-and-stale-path--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-ligan-promisebase-reference-naming`
- Scenario ID: `bgp-class-routing-app-partition-and-stale-path`
