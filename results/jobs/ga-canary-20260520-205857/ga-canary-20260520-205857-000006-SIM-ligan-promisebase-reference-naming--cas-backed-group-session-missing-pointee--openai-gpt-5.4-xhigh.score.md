...
- Cell ID: `ga-canary-20260520-205857-000006-SIM-ligan-promisebase-reference-naming--cas-backed-group-session-missing-pointee--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-ligan-promisebase-reference-naming`
- Scenario ID: `cas-backed-group-session-missing-pointee`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-ligan-promisebase-reference-naming/cas-backed-group-session-missing-pointee/openai-gpt-5.4-xhigh/20260520-205857.json`
