...
- Run group ID: `ga-calib-20260523-033216-xhigh`
- Cell ID: `ga-calib-20260523-033216-xhigh-000002-SIM-kurim-grid-envelope--cas-backed-group-session-envelope-independence--openai-gpt-5.4-xhigh`
...
- Result path: `results/SIM-kurim-grid-envelope/cas-backed-group-session-envelope-independence/openai-gpt-5.4-xhigh/20260523-033216.json`
