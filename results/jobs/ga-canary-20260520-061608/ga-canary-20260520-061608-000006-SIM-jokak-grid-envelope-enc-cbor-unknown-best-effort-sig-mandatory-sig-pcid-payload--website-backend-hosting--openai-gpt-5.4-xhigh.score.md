...
- Run group ID: `ga-canary-20260520-061608`
- Cell ID: `ga-canary-20260520-061608-000006-SIM-jokak-grid-envelope-enc-cbor-unknown-best-effort-sig-mandatory-sig-pcid-payload--website-backend-hosting--openai-gpt-5.4-xhigh`
...
- Result path: `results/SIM-jokak-grid-envelope-enc-cbor-unknown-best-effort-sig-mandatory-sig-pcid-payload/website-backend-hosting/openai-gpt-5.4-xhigh/20260520-061608.json`
