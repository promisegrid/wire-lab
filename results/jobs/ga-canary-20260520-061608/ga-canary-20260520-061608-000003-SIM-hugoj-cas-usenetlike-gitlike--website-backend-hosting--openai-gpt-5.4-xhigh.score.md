...
- Cell ID: `ga-canary-20260520-061608-000003-SIM-hugoj-cas-usenetlike-gitlike--website-backend-hosting--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-hugoj-cas-usenetlike-gitlike`
- Scenario ID: `website-backend-hosting`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-hugoj-cas-usenetlike-gitlike/website-backend-hosting/openai-gpt-5.4-xhigh/20260520-061608.json`
