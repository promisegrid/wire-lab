...
- Cell ID: `ga-canary-20260523-extracted-34x7-000034-SIM-bihim-cas-type-codec-plus-internal-kind--group-session-freeze-promise-post-freeze-mutation-request--openai-gpt-5.4-medium`
- Simulation ID: `SIM-bihim-cas-type-codec-plus-internal-kind`
- Scenario ID: `group-session-freeze-promise-post-freeze-mutation-request`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-bihim-cas-type-codec-plus-internal-kind/group-session-freeze-promise-post-freeze-mutation-request/openai-gpt-5.4-medium/20260523-230210.json`
...
### `simulations/SIM-bihim-cas-type-codec-plus-internal-kind/README.md`
...
### `simulations/SIM-bihim-cas-type-codec-plus-internal-kind/QUESTION.md`

```markdown
# Question

Can a broad CID codec plus an internal kind field give Carol finer CAS object
dispatch without weakening the content identity that Alice and Bob verify?
