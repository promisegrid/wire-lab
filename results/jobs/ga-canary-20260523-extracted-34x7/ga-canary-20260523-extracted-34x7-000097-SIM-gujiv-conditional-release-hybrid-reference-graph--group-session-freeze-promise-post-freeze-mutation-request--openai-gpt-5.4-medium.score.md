...
- Cell ID: `ga-canary-20260523-extracted-34x7-000097-SIM-gujiv-conditional-release-hybrid-reference-graph--group-session-freeze-promise-post-freeze-mutation-request--openai-gpt-5.4-medium`
- Simulation ID: `SIM-gujiv-conditional-release-hybrid-reference-graph`
- Scenario ID: `group-session-freeze-promise-post-freeze-mutation-request`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-gujiv-conditional-release-hybrid-reference-graph/group-session-freeze-promise-post-freeze-mutation-request/openai-gpt-5.4-medium/20260523-230210.json`
...
### `simulations/SIM-gujiv-conditional-release-hybrid-reference-graph/README.md`
...
### `simulations/SIM-gujiv-conditional-release-hybrid-reference-graph/QUESTION.md`

```markdown
# Question

Can a hybrid release-condition graph keep human promise meaning at the group
layer while giving storage, transport, and audit layers enough stable references
