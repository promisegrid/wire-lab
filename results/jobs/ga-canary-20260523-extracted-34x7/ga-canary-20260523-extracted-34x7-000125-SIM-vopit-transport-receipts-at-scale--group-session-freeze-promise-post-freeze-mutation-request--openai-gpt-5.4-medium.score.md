...
- Cell ID: `ga-canary-20260523-extracted-34x7-000125-SIM-vopit-transport-receipts-at-scale--group-session-freeze-promise-post-freeze-mutation-request--openai-gpt-5.4-medium`
- Simulation ID: `SIM-vopit-transport-receipts-at-scale`
- Scenario ID: `group-session-freeze-promise-post-freeze-mutation-request`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-vopit-transport-receipts-at-scale/group-session-freeze-promise-post-freeze-mutation-request/openai-gpt-5.4-medium/20260523-230210.json`
...
### `simulations/SIM-vopit-transport-receipts-at-scale/README.md`
...
### `simulations/SIM-vopit-transport-receipts-at-scale/QUESTION.md`

```markdown
# Question

What receipt structure lets Alice, Bob, and Carol audit delivery at scale
without forcing every peer to retain unbounded per-message acknowledgement
state?
