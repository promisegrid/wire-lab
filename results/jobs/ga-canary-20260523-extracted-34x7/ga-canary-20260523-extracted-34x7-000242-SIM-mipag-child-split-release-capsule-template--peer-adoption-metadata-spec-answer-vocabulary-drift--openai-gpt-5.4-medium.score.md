...
- Cell ID: `ga-canary-20260523-extracted-34x7-000242-SIM-mipag-child-split-release-capsule-template--peer-adoption-metadata-spec-answer-vocabulary-drift--openai-gpt-5.4-medium`
- Simulation ID: `SIM-mipag-child-split-release-capsule-template`
- Scenario ID: `peer-adoption-metadata-spec-answer-vocabulary-drift`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `proposals/ga-canary-20260523-extracted-34x7/results/SIM-mipag-child-split-release-capsule-template/peer-adoption-metadata-spec-answer-vocabulary-drift/openai-gpt-5.4-medium/20260523-230210.json`
