...
- Cell ID: `ga-canary-20260523-extracted-34x7-000090-SIM-dujoh-conditional-release-transport-visible-constraint--group-session-freeze-promise-post-freeze-mutation-request--openai-gpt-5.4-medium`
- Simulation ID: `SIM-dujoh-conditional-release-transport-visible-constraint`
- Scenario ID: `group-session-freeze-promise-post-freeze-mutation-request`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-dujoh-conditional-release-transport-visible-constraint/group-session-freeze-promise-post-freeze-mutation-request/openai-gpt-5.4-medium/20260523-230210.json`
...
### `simulations/SIM-dujoh-conditional-release-transport-visible-constraint/README.md`
...
### `simulations/SIM-dujoh-conditional-release-transport-visible-constraint/QUESTION.md`

```markdown
# Question

How much conditional-release metadata must be visible to transport or feed
layers before Bob can honestly promise not to forward or store content in
forbidden contexts?
