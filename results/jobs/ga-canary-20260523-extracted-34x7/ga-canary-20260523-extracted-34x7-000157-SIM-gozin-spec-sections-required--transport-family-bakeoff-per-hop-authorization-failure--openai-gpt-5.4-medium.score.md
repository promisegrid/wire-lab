...
- Cell ID: `ga-canary-20260523-extracted-34x7-000157-SIM-gozin-spec-sections-required--transport-family-bakeoff-per-hop-authorization-failure--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-gozin-spec-sections-required/transport-family-bakeoff-per-hop-authorization-failure/openai-gpt-5.4-medium/20260523-230210.json`
