...
- Cell ID: `ga-canary-20260523-extracted-34x7-000069-SIM-nalug-chunking-raw-only-first-profile--group-session-freeze-promise-post-freeze-mutation-request--openai-gpt-5.4-medium`
- Simulation ID: `SIM-nalug-chunking-raw-only-first-profile`
- Scenario ID: `group-session-freeze-promise-post-freeze-mutation-request`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-nalug-chunking-raw-only-first-profile/group-session-freeze-promise-post-freeze-mutation-request/openai-gpt-5.4-medium/20260523-230210.json`
...
### `simulations/SIM-nalug-chunking-raw-only-first-profile/README.md`
...
### `simulations/SIM-nalug-chunking-raw-only-first-profile/QUESTION.md`

```markdown
# Question

Can PromiseGrid safely start with raw-only CAS identity while deferring chunked
Merkle identity, or does that leave too little evidence for sparse replication
and large-object flows?
