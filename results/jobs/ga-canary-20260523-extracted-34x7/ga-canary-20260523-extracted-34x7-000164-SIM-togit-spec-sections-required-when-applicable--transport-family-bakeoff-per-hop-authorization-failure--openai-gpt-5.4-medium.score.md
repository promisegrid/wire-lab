...
- Cell ID: `ga-canary-20260523-extracted-34x7-000164-SIM-togit-spec-sections-required-when-applicable--transport-family-bakeoff-per-hop-authorization-failure--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-togit-spec-sections-required-when-applicable/transport-family-bakeoff-per-hop-authorization-failure/openai-gpt-5.4-medium/20260523-230210.json`
