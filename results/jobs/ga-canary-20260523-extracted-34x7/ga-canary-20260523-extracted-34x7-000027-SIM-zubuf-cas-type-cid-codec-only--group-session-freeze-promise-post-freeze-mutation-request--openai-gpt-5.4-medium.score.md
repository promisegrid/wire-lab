...
- Cell ID: `ga-canary-20260523-extracted-34x7-000027-SIM-zubuf-cas-type-cid-codec-only--group-session-freeze-promise-post-freeze-mutation-request--openai-gpt-5.4-medium`
- Simulation ID: `SIM-zubuf-cas-type-cid-codec-only`
- Scenario ID: `group-session-freeze-promise-post-freeze-mutation-request`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-zubuf-cas-type-cid-codec-only/group-session-freeze-promise-post-freeze-mutation-request/openai-gpt-5.4-medium/20260523-230210.json`
...
### `simulations/SIM-zubuf-cas-type-cid-codec-only/README.md`
...
### `simulations/SIM-zubuf-cas-type-cid-codec-only/QUESTION.md`

```markdown
# Question

Can CID codec selection alone distinguish PromiseGrid CAS object families
without making future object evolution ambiguous or dependent on path names?
