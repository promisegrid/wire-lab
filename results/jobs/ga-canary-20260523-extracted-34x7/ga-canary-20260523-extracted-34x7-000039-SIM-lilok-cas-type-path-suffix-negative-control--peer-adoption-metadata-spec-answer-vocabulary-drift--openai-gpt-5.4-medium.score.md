...
- Cell ID: `ga-canary-20260523-extracted-34x7-000039-SIM-lilok-cas-type-path-suffix-negative-control--peer-adoption-metadata-spec-answer-vocabulary-drift--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-lilok-cas-type-path-suffix-negative-control/peer-adoption-metadata-spec-answer-vocabulary-drift/openai-gpt-5.4-medium/20260523-230210.json`
