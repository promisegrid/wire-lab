...
- Cell ID: `ga-canary-20260523-extracted-34x7-000118-SIM-numop-transport-gossip--group-session-freeze-promise-post-freeze-mutation-request--openai-gpt-5.4-medium`
- Simulation ID: `SIM-numop-transport-gossip`
- Scenario ID: `group-session-freeze-promise-post-freeze-mutation-request`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-numop-transport-gossip/group-session-freeze-promise-post-freeze-mutation-request/openai-gpt-5.4-medium/20260523-230210.json`
...
### `simulations/SIM-numop-transport-gossip/README.md`
...
### `simulations/SIM-numop-transport-gossip/QUESTION.md`

```markdown
# Question

Can gossip transport give PromiseGrid useful convergence and offline tolerance
while preserving auditable peer promises about what was advertised, requested,
and relayed?
