...
- Cell ID: `ga-canary-20260523-extracted-34x7-000167-SIM-togit-spec-sections-required-when-applicable--group-session-freeze-promise-post-freeze-mutation-request--openai-gpt-5.4-medium`
- Simulation ID: `SIM-togit-spec-sections-required-when-applicable`
- Scenario ID: `group-session-freeze-promise-post-freeze-mutation-request`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-togit-spec-sections-required-when-applicable/group-session-freeze-promise-post-freeze-mutation-request/openai-gpt-5.4-medium/20260523-230210.json`
...
### `simulations/SIM-togit-spec-sections-required-when-applicable/README.md`
...
### `simulations/SIM-togit-spec-sections-required-when-applicable/QUESTION.md`

```markdown
# Question

Can required-when-applicable spec sections keep PromiseGrid specs concise while
still forcing authors to explain durable promises whenever the explanation is
load-bearing?
