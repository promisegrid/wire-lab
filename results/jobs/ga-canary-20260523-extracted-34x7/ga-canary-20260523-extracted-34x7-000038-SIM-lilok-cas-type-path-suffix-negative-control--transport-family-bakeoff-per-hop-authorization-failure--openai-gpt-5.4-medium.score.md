...
- Cell ID: `ga-canary-20260523-extracted-34x7-000038-SIM-lilok-cas-type-path-suffix-negative-control--transport-family-bakeoff-per-hop-authorization-failure--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-lilok-cas-type-path-suffix-negative-control/transport-family-bakeoff-per-hop-authorization-failure/openai-gpt-5.4-medium/20260523-230210.json`
