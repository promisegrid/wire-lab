...
- Cell ID: `ga-canary-20260523-extracted-34x7-000210-SIM-fiboh-group-session-deferred-freeze--udp-feed-v0-conformance-session-layer-composition--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-fiboh-group-session-deferred-freeze/udp-feed-v0-conformance-session-layer-composition/openai-gpt-5.4-medium/20260523-230210.json`
