...
- Cell ID: `ga-canary-20260523-extracted-34x7-000104-SIM-jomaj-transport-token-ring--group-session-freeze-promise-post-freeze-mutation-request--openai-gpt-5.4-medium`
- Simulation ID: `SIM-jomaj-transport-token-ring`
- Scenario ID: `group-session-freeze-promise-post-freeze-mutation-request`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-jomaj-transport-token-ring/group-session-freeze-promise-post-freeze-mutation-request/openai-gpt-5.4-medium/20260523-230210.json`
...
### `simulations/SIM-jomaj-transport-token-ring/README.md`
...
### `simulations/SIM-jomaj-transport-token-ring/QUESTION.md`

```markdown
# Question

Can token-ring transport give PromiseGrid useful ordering and per-hop promises
without making mixed-version peers, offline peers, or partition recovery too
fragile?
