...
- Cell ID: `ga-canary-20260523-extracted-34x7-000168-SIM-togit-spec-sections-required-when-applicable--udp-feed-v0-conformance-session-layer-composition--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-togit-spec-sections-required-when-applicable/udp-feed-v0-conformance-session-layer-composition/openai-gpt-5.4-medium/20260523-230210.json`
