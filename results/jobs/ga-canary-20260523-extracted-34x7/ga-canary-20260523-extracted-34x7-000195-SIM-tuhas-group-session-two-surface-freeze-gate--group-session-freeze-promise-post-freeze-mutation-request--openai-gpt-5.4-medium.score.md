...
- Cell ID: `ga-canary-20260523-extracted-34x7-000195-SIM-tuhas-group-session-two-surface-freeze-gate--group-session-freeze-promise-post-freeze-mutation-request--openai-gpt-5.4-medium`
- Simulation ID: `SIM-tuhas-group-session-two-surface-freeze-gate`
