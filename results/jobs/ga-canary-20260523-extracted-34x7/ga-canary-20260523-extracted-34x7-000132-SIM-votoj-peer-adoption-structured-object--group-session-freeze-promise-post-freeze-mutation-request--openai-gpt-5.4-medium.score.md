...
- Cell ID: `ga-canary-20260523-extracted-34x7-000132-SIM-votoj-peer-adoption-structured-object--group-session-freeze-promise-post-freeze-mutation-request--openai-gpt-5.4-medium`
- Simulation ID: `SIM-votoj-peer-adoption-structured-object`
- Scenario ID: `group-session-freeze-promise-post-freeze-mutation-request`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-votoj-peer-adoption-structured-object/group-session-freeze-promise-post-freeze-mutation-request/openai-gpt-5.4-medium/20260523-230210.json`
...
### `simulations/SIM-votoj-peer-adoption-structured-object/README.md`
...
### `simulations/SIM-votoj-peer-adoption-structured-object/QUESTION.md`

```markdown
# Question

Can a content-addressed adoption object make Bob's promised spec pCID and
open-question answers precise enough for Carol to verify without creating a
large metadata wrapper around every protocol adoption?
