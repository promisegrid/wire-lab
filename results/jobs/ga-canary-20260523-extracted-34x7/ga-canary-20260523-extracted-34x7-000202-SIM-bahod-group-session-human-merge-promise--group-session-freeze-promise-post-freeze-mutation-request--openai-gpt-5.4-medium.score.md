...
- Cell ID: `ga-canary-20260523-extracted-34x7-000202-SIM-bahod-group-session-human-merge-promise--group-session-freeze-promise-post-freeze-mutation-request--openai-gpt-5.4-medium`
- Simulation ID: `SIM-bahod-group-session-human-merge-promise`
- Scenario ID: `group-session-freeze-promise-post-freeze-mutation-request`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-bahod-group-session-human-merge-promise/group-session-freeze-promise-post-freeze-mutation-request/openai-gpt-5.4-medium/20260523-230210.json`
...
### `simulations/SIM-bahod-group-session-human-merge-promise/README.md`

```markdown
# SIM-bahod-group-session-human-merge-promise

This simulation turns the human merge-promise alternative from
`SIM-bohof-group-session-freeze-promise` into a concrete candidate specimen. It
tests whether Steve can make a plain-English `merge-group-transport-spec`
promise that points at exact artifacts and is precise enough for early freeze
work. Source: `DI-fibuv`.

## Design Under Test

The freeze action is a human-authored promise naming exact paths, CIDs, scope,
and unresolved questions. The promise is treated as evidence until stronger
signed-promise tooling exists.

## Boundaries

This simulation does not sign or execute a merge. It tests whether plain-English
promise wording can be durable enough for early specimen governance.
```

### `simulations/SIM-bahod-group-session-human-merge-promise/QUESTION.md`

```markdown
# Question

Can a human-authored merge promise be precise enough to freeze a group-session
specimen without cryptographic promise tooling, or does it leave too much scope
ambiguity?
