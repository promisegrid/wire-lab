...
- Cell ID: `ga-canary-20260523-extracted-34x7-000025-SIM-zubuf-cas-type-cid-codec-only--peer-adoption-metadata-spec-answer-vocabulary-drift--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-zubuf-cas-type-cid-codec-only/peer-adoption-metadata-spec-answer-vocabulary-drift/openai-gpt-5.4-medium/20260523-230210.json`
