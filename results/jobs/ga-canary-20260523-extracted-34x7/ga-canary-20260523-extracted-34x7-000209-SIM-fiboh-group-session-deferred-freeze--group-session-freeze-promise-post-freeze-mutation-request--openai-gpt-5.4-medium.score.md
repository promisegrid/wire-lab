...
- Cell ID: `ga-canary-20260523-extracted-34x7-000209-SIM-fiboh-group-session-deferred-freeze--group-session-freeze-promise-post-freeze-mutation-request--openai-gpt-5.4-medium`
- Simulation ID: `SIM-fiboh-group-session-deferred-freeze`
- Scenario ID: `group-session-freeze-promise-post-freeze-mutation-request`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-fiboh-group-session-deferred-freeze/group-session-freeze-promise-post-freeze-mutation-request/openai-gpt-5.4-medium/20260523-230210.json`
...
### `simulations/SIM-fiboh-group-session-deferred-freeze/README.md`
...
### `simulations/SIM-fiboh-group-session-deferred-freeze/QUESTION.md`

```markdown
# Question

Should group-session freeze wait for stronger pCID and cryptographic promise
tooling, even if exact specimen evidence is already reproducible?
