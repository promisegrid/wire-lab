...
- Run group ID: `ga-calib-20260523-033216-low`
- Cell ID: `ga-calib-20260523-033216-low-000002-SIM-kurim-grid-envelope--cas-backed-group-session-envelope-independence--openai-gpt-5.4-low`
- Simulation ID: `SIM-kurim-grid-envelope`
- Scenario ID: `cas-backed-group-session-envelope-independence`
- Model ID: `openai-gpt-5.4-low`
- Result path: `results/SIM-kurim-grid-envelope/cas-backed-group-session-envelope-independence/openai-gpt-5.4-low/20260523-033216.json`
