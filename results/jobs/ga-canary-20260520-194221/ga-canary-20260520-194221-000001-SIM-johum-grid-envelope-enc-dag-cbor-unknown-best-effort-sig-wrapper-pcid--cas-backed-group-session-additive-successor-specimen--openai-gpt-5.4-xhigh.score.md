...
- Cell ID: `ga-canary-20260520-194221-000001-SIM-johum-grid-envelope-enc-dag-cbor-unknown-best-effort-sig-wrapper-pcid--cas-backed-group-session-additive-successor-specimen--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-johum-grid-envelope-enc-dag-cbor-unknown-best-effort-sig-wrapper-pcid`
- Scenario ID: `cas-backed-group-session-additive-successor-specimen`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-johum-grid-envelope-enc-dag-cbor-unknown-best-effort-sig-wrapper-pcid/cas-backed-group-session-additive-successor-specimen/openai-gpt-5.4-xhigh/20260520-194221.json`
