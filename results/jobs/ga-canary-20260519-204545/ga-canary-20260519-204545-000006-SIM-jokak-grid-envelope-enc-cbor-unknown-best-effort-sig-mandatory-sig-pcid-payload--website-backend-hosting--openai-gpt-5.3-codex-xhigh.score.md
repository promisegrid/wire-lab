...
- Run group ID: `ga-canary-20260519-204545`
- Cell ID: `ga-canary-20260519-204545-000006-SIM-jokak-grid-envelope-enc-cbor-unknown-best-effort-sig-mandatory-sig-pcid-payload--website-backend-hosting--openai-gpt-5.3-codex-xhigh`
- Simulation ID: `SIM-jokak-grid-envelope-enc-cbor-unknown-best-effort-sig-mandatory-sig-pcid-payload`
- Scenario ID: `website-backend-hosting`
- Model ID: `openai-gpt-5.3-codex-xhigh`
- Result path: `results/SIM-jokak-grid-envelope-enc-cbor-unknown-best-effort-sig-mandatory-sig-pcid-payload/website-backend-hosting/openai-gpt-5.3-codex-xhigh/20260519-204545.json`
