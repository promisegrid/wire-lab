...
- Cell ID: `ga-canary-20260519-184045-000002-SIM-hugoj-cas-usenetlike-gitlike--state-governance--openai-gpt-5.3-codex-xhigh`
- Simulation ID: `SIM-hugoj-cas-usenetlike-gitlike`
- Scenario ID: `state-governance`
- Model ID: `openai-gpt-5.3-codex-xhigh`
- Result path: `results/SIM-hugoj-cas-usenetlike-gitlike/state-governance/openai-gpt-5.3-codex-xhigh/20260519-184045.json`
