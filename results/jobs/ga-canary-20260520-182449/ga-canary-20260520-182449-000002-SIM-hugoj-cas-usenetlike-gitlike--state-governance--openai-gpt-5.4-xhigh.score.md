...
- Cell ID: `ga-canary-20260520-182449-000002-SIM-hugoj-cas-usenetlike-gitlike--state-governance--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-hugoj-cas-usenetlike-gitlike`
- Scenario ID: `state-governance`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-hugoj-cas-usenetlike-gitlike/state-governance/openai-gpt-5.4-xhigh/20260520-182449.json`
