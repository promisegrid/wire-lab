...
- Run group ID: `ga-tugoz-20260523-073108-suzuf`
- Cell ID: `ga-tugoz-20260523-073108-suzuf-000004-SIM-suzuf-gordian-universal-envelope-negative-control--chunk-feed-replication-sparse-advertisement--openai-gpt-5.4-medium`
- Simulation ID: `SIM-suzuf-gordian-universal-envelope-negative-control`
- Scenario ID: `chunk-feed-replication-sparse-advertisement`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-suzuf-gordian-universal-envelope-negative-control/chunk-feed-replication-sparse-advertisement/openai-gpt-5.4-medium/20260523-073120.json`
...
### `simulations/SIM-suzuf-gordian-universal-envelope-negative-control/README.md`

```markdown
# SIM-suzuf-gordian-universal-envelope-negative-control: Gordian universal-envelope negative control

This simulation is a standalone negative-control specimen. It asks what happens
if Gordian-style subject/assertion/proof structure becomes the universal outer
envelope rather than a pCID-owned payload family. Source: `DI-nohir`.

The local draft spec is
`protocols/grid-envelope.d/specs/grid-envelope-draft.md`.

Primary comparison targets: `SIM-fitin` and the minimal-grid family.
```

### `simulations/SIM-suzuf-gordian-universal-envelope-negative-control/QUESTION.md`

```markdown
# Question

If PromiseGrid made Gordian-style subject/assertion/proof structure part of the
universal outer envelope, would the resulting parser and audit gains outweigh
the added small-device burden, migration complexity, and 100-year durability
costs? Source: `DI-nohir`.
```

### `simulations/SIM-suzuf-gordian-universal-envelope-negative-control/protocols/grid-envelope.d/specs/grid-envelope-draft.md`
