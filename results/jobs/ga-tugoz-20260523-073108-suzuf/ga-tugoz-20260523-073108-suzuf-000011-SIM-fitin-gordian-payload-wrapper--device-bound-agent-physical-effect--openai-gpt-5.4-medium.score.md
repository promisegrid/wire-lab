...
- Cell ID: `ga-tugoz-20260523-073108-suzuf-000011-SIM-fitin-gordian-payload-wrapper--device-bound-agent-physical-effect--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-fitin-gordian-payload-wrapper/device-bound-agent-physical-effect/openai-gpt-5.4-medium/20260523-073120.json`
