...
- Cell ID: `ga-tugoz-20260523-073108-suzuf-000007-SIM-fitin-gordian-payload-wrapper--portable-signing-key-identity--openai-gpt-5.4-medium`
- Simulation ID: `SIM-fitin-gordian-payload-wrapper`
- Scenario ID: `portable-signing-key-identity`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-fitin-gordian-payload-wrapper/portable-signing-key-identity/openai-gpt-5.4-medium/20260523-073120.json`
