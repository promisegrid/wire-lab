...
- Cell ID: `ga-tugoz-20260523-073108-suzuf-000009-SIM-fitin-gordian-payload-wrapper--multi-embodiment-app-identity--openai-gpt-5.4-medium`
- Simulation ID: `SIM-fitin-gordian-payload-wrapper`
- Scenario ID: `multi-embodiment-app-identity`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-fitin-gordian-payload-wrapper/multi-embodiment-app-identity/openai-gpt-5.4-medium/20260523-073120.json`
