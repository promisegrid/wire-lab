...
- Cell ID: `ga-tugoz-20260523-073108-suzuf-000005-SIM-suzuf-gordian-universal-envelope-negative-control--device-bound-agent-physical-effect--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-suzuf-gordian-universal-envelope-negative-control/device-bound-agent-physical-effect/openai-gpt-5.4-medium/20260523-073120.json`
