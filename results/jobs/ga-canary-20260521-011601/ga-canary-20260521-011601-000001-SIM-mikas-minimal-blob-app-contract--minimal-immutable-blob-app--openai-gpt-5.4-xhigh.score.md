...
- Cell ID: `ga-canary-20260521-011601-000001-SIM-mikas-minimal-blob-app-contract--minimal-immutable-blob-app--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-mikas-minimal-blob-app-contract`
- Scenario ID: `minimal-immutable-blob-app`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-mikas-minimal-blob-app-contract/minimal-immutable-blob-app/openai-gpt-5.4-xhigh/20260521-011601.json`
