...
- Cell ID: `ga-canary-20260521-011601-000042-SIM-funas-kernel-porting-boundary--kernel-porting-boundary--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-funas-kernel-porting-boundary`
- Scenario ID: `kernel-porting-boundary`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-funas-kernel-porting-boundary/kernel-porting-boundary/openai-gpt-5.4-xhigh/20260521-011601.json`
