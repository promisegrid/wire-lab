...
- Cell ID: `ga-canary-20260521-011601-000017-SIM-zisan-device-bound-agent--device-bound-agent-physical-effect--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-zisan-device-bound-agent`
- Scenario ID: `device-bound-agent-physical-effect`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-zisan-device-bound-agent/device-bound-agent-physical-effect/openai-gpt-5.4-xhigh/20260521-011601.json`
