...
- Cell ID: `ga-canary-20260521-011601-000036-SIM-funas-kernel-porting-boundary--minimal-immutable-blob-app--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-funas-kernel-porting-boundary`
- Scenario ID: `minimal-immutable-blob-app`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-funas-kernel-porting-boundary/minimal-immutable-blob-app/openai-gpt-5.4-xhigh/20260521-011601.json`
