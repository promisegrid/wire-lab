...
- Cell ID: `ga-canary-20260521-011601-000039-SIM-funas-kernel-porting-boundary--live-crdt-audit-publication--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-funas-kernel-porting-boundary`
- Scenario ID: `live-crdt-audit-publication`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-funas-kernel-porting-boundary/live-crdt-audit-publication/openai-gpt-5.4-xhigh/20260521-011601.json`
