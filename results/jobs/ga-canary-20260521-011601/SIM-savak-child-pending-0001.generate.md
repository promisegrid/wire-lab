...
Choose a descriptive `child_id` that starts with `SIM-savak-child-` and ends with a kebab-case design slug. Do not use generic `ga-child`, `pending`, or ordinal-only names.
...
- Planned child ID prefix: `SIM-savak-child-`
- Temporary child ID: `SIM-savak-child-pending-0001`
- Temporary child path: `proposals/ga-canary-20260521-011601/simulations/SIM-savak-child-pending-0001/`
- Operation: `breed`
...
{"child_id":"SIM-savak-child-descriptive-design-slug","design_delta_summary":"one to three bounded design deltas","files":[{"path":"README.md","content":"# ..."},{"path":"QUESTION.md","content":"# ..."}]}
