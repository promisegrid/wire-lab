...
- Cell ID: `ga-canary-20260521-011601-000040-SIM-funas-kernel-porting-boundary--multi-embodiment-app-identity--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-funas-kernel-porting-boundary`
- Scenario ID: `multi-embodiment-app-identity`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-funas-kernel-porting-boundary/multi-embodiment-app-identity/openai-gpt-5.4-xhigh/20260521-011601.json`
