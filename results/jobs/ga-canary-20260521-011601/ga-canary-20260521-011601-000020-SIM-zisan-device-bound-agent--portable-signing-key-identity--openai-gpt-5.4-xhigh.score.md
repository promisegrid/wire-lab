...
- Cell ID: `ga-canary-20260521-011601-000020-SIM-zisan-device-bound-agent--portable-signing-key-identity--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-zisan-device-bound-agent`
- Scenario ID: `portable-signing-key-identity`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-zisan-device-bound-agent/portable-signing-key-identity/openai-gpt-5.4-xhigh/20260521-011601.json`
