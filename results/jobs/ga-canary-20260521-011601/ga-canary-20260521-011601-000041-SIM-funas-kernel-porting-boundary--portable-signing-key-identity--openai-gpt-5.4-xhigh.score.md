...
- Cell ID: `ga-canary-20260521-011601-000041-SIM-funas-kernel-porting-boundary--portable-signing-key-identity--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-funas-kernel-porting-boundary`
- Scenario ID: `portable-signing-key-identity`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-funas-kernel-porting-boundary/portable-signing-key-identity/openai-gpt-5.4-xhigh/20260521-011601.json`
