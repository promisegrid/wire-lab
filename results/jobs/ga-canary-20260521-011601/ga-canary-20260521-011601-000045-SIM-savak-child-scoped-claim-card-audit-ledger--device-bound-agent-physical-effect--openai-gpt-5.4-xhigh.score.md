...
- Cell ID: `ga-canary-20260521-011601-000045-SIM-savak-child-scoped-claim-card-audit-ledger--device-bound-agent-physical-effect--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-savak-child-scoped-claim-card-audit-ledger`
- Scenario ID: `device-bound-agent-physical-effect`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `proposals/ga-canary-20260521-011601/results/SIM-savak-child-scoped-claim-card-audit-ledger/device-bound-agent-physical-effect/openai-gpt-5.4-xhigh/20260521-011601.json`
...
### `proposals/ga-canary-20260521-011601/simulations/SIM-savak-child-scoped-claim-card-audit-ledger/README.md`

```markdown
# SIM-savak-child: Scoped claim card + audit ledger

This child breeds `SIM-robot-app-semantics-conformance` with `SIM-kugap-live-sync-audit-split` by turning their strongest boundary ideas into concrete evidence shapes.
...
3. a local append-only **promise ledger** for failures, retries, retention changes, and break-witnesses.

## Why this should score higher

The parents were strong on honesty and layer separation, but weak on concrete claim format, exact cited audit object, and local evidence shape. This child repairs those gaps without freezing an app SDK or live transport.
...
### `proposals/ga-canary-20260521-011601/simulations/SIM-savak-child-scoped-claim-card-audit-ledger/QUESTION.md`

```markdown
# Question

How should PromiseGrid require scoped claim cards, exact audit-anchor citations, and minimal local promise ledgers so early apps can make honest partial-conformance claims without conflating:
...
- What is the minimum ledger entry set needed for 100-year audit without over-prescribing implementation?
```

### `proposals/ga-canary-20260521-011601/simulations/SIM-savak-child-scoped-claim-card-audit-ledger/PATTERNS.md`
