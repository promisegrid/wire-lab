...
- Cell ID: `ga-canary-20260521-011601-000032-SIM-nijuz-multi-embodiment-identity--live-crdt-audit-publication--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-nijuz-multi-embodiment-identity`
- Scenario ID: `live-crdt-audit-publication`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-nijuz-multi-embodiment-identity/live-crdt-audit-publication/openai-gpt-5.4-xhigh/20260521-011601.json`
