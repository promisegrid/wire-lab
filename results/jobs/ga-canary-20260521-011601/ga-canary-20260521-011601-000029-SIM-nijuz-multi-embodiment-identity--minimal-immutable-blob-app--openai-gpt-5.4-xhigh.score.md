...
- Cell ID: `ga-canary-20260521-011601-000029-SIM-nijuz-multi-embodiment-identity--minimal-immutable-blob-app--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-nijuz-multi-embodiment-identity`
- Scenario ID: `minimal-immutable-blob-app`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-nijuz-multi-embodiment-identity/minimal-immutable-blob-app/openai-gpt-5.4-xhigh/20260521-011601.json`
