...
- Cell ID: `ga-canary-20260521-011601-000033-SIM-nijuz-multi-embodiment-identity--multi-embodiment-app-identity--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-nijuz-multi-embodiment-identity`
- Scenario ID: `multi-embodiment-app-identity`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-nijuz-multi-embodiment-identity/multi-embodiment-app-identity/openai-gpt-5.4-xhigh/20260521-011601.json`
