...
- Cell ID: `ga-canary-20260521-011601-000004-SIM-mikas-minimal-blob-app-contract--live-crdt-audit-publication--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-mikas-minimal-blob-app-contract`
- Scenario ID: `live-crdt-audit-publication`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-mikas-minimal-blob-app-contract/live-crdt-audit-publication/openai-gpt-5.4-xhigh/20260521-011601.json`
