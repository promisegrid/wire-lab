...
- Cell ID: `ga-canary-20260525-hozif-anti-rpc-calibration-000002-SIM-hozif-app-pcid-promises-local-observations--promise-accounting-records-kept-storage-promise--openai-gpt-5.4-medium`
- Simulation ID: `SIM-hozif-app-pcid-promises-local-observations`
- Scenario ID: `promise-accounting-records-kept-storage-promise`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-hozif-app-pcid-promises-local-observations/promise-accounting-records-kept-storage-promise/openai-gpt-5.4-medium/20260526-003243.json`
...
### `simulations/SIM-hozif-app-pcid-promises-local-observations/README.md`
...
### `simulations/SIM-hozif-app-pcid-promises-local-observations/QUESTION.md`

```markdown
# Question

Can PromiseGrid replace RPC-like app/kernel registration with one stable pCID-selected local promise protocol whose payload kinds let an app promise a local kernel which pCID-selected messages it will receive or handle, let the kernel promise best-effort delivery and local evidence behavior, and let each agent record kept, refused, broken, or timed-out outcomes only as its own local observation?
```

### `simulations/SIM-hozif-app-pcid-promises-local-observations/protocols/app-kernel-local-promises.d/specs/app-kernel-local-promises-draft.md`
...
### `simulations/SIM-hozif-app-pcid-promises-local-observations/protocols/grid-envelope.d/specs/grid-envelope-draft.md`
