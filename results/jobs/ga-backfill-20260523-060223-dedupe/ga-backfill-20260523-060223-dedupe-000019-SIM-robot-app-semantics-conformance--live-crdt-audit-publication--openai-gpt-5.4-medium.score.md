...
- Cell ID: `ga-backfill-20260523-060223-dedupe-000019-SIM-robot-app-semantics-conformance--live-crdt-audit-publication--openai-gpt-5.4-medium`
- Simulation ID: `SIM-robot-app-semantics-conformance`
- Scenario ID: `live-crdt-audit-publication`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-robot-app-semantics-conformance/live-crdt-audit-publication/openai-gpt-5.4-medium/20260523-060228.json`
