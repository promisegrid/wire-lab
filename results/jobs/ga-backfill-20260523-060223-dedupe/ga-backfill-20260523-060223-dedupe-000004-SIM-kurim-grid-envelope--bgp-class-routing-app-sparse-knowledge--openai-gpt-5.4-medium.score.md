...
- Cell ID: `ga-backfill-20260523-060223-dedupe-000004-SIM-kurim-grid-envelope--bgp-class-routing-app-sparse-knowledge--openai-gpt-5.4-medium`
- Simulation ID: `SIM-kurim-grid-envelope`
- Scenario ID: `bgp-class-routing-app-sparse-knowledge`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-kurim-grid-envelope/bgp-class-routing-app-sparse-knowledge/openai-gpt-5.4-medium/20260523-060228.json`
