...
- Cell ID: `ga-backfill-20260523-060223-dedupe-000014-SIM-kurim-grid-envelope--udp-feed-v0-conformance-malformed-datagram--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-kurim-grid-envelope/udp-feed-v0-conformance-malformed-datagram/openai-gpt-5.4-medium/20260523-060228.json`
