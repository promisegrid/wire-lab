...
- Cell ID: `ga-backfill-20260523-060223-dedupe-000020-SIM-robot-app-semantics-conformance--minimal-immutable-blob-app--openai-gpt-5.4-medium`
- Simulation ID: `SIM-robot-app-semantics-conformance`
- Scenario ID: `minimal-immutable-blob-app`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-robot-app-semantics-conformance/minimal-immutable-blob-app/openai-gpt-5.4-medium/20260523-060228.json`
