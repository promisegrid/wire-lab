...
- Cell ID: `ga-backfill-20260523-060223-dedupe-000021-SIM-robot-app-semantics-conformance--multi-embodiment-app-identity--openai-gpt-5.4-medium`
- Simulation ID: `SIM-robot-app-semantics-conformance`
- Scenario ID: `multi-embodiment-app-identity`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-robot-app-semantics-conformance/multi-embodiment-app-identity/openai-gpt-5.4-medium/20260523-060228.json`
