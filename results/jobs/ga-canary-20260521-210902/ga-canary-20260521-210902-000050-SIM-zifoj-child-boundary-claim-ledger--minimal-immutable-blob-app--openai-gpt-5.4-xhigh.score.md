...
- Cell ID: `ga-canary-20260521-210902-000050-SIM-zifoj-child-boundary-claim-ledger--minimal-immutable-blob-app--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-zifoj-child-boundary-claim-ledger`
- Scenario ID: `minimal-immutable-blob-app`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `proposals/ga-canary-20260521-210902/results/SIM-zifoj-child-boundary-claim-ledger/minimal-immutable-blob-app/openai-gpt-5.4-xhigh/20260521-210902.json`
