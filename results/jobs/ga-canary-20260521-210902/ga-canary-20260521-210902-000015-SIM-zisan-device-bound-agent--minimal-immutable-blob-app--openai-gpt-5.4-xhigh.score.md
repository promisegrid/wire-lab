...
- Cell ID: `ga-canary-20260521-210902-000015-SIM-zisan-device-bound-agent--minimal-immutable-blob-app--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-zisan-device-bound-agent`
- Scenario ID: `minimal-immutable-blob-app`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-zisan-device-bound-agent/minimal-immutable-blob-app/openai-gpt-5.4-xhigh/20260521-210902.json`
