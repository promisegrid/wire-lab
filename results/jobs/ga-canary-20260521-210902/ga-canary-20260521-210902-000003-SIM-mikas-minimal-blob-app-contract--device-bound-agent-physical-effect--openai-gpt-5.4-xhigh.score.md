...
- Cell ID: `ga-canary-20260521-210902-000003-SIM-mikas-minimal-blob-app-contract--device-bound-agent-physical-effect--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-mikas-minimal-blob-app-contract`
- Scenario ID: `device-bound-agent-physical-effect`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-mikas-minimal-blob-app-contract/device-bound-agent-physical-effect/openai-gpt-5.4-xhigh/20260521-210902.json`
...
### `simulations/SIM-mikas-minimal-blob-app-contract/README.md`
...
### `simulations/SIM-mikas-minimal-blob-app-contract/QUESTION.md`
