...
- Cell ID: `ga-canary-20260521-210902-000021-SIM-zisan-device-bound-agent--kernel-porting-boundary--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-zisan-device-bound-agent`
- Scenario ID: `kernel-porting-boundary`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-zisan-device-bound-agent/kernel-porting-boundary/openai-gpt-5.4-xhigh/20260521-210902.json`
