...
- Cell ID: `ga-canary-20260521-210902-000016-SIM-zisan-device-bound-agent--app-semantics-partial-conformance--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-zisan-device-bound-agent`
- Scenario ID: `app-semantics-partial-conformance`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-zisan-device-bound-agent/app-semantics-partial-conformance/openai-gpt-5.4-xhigh/20260521-210902.json`
