...
- Cell ID: `ga-canary-20260521-210902-000005-SIM-mikas-minimal-blob-app-contract--multi-embodiment-app-identity--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-mikas-minimal-blob-app-contract`
- Scenario ID: `multi-embodiment-app-identity`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-mikas-minimal-blob-app-contract/multi-embodiment-app-identity/openai-gpt-5.4-xhigh/20260521-210902.json`
