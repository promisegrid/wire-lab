...
- Cell ID: `ga-canary-20260521-210902-000019-SIM-zisan-device-bound-agent--multi-embodiment-app-identity--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-zisan-device-bound-agent`
- Scenario ID: `multi-embodiment-app-identity`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-zisan-device-bound-agent/multi-embodiment-app-identity/openai-gpt-5.4-xhigh/20260521-210902.json`
