...
- Cell ID: `ga-canary-20260521-210902-000045-SIM-virim-child-manifested-embodiment-savepoint-receipts--device-bound-agent-physical-effect--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-virim-child-manifested-embodiment-savepoint-receipts`
- Scenario ID: `device-bound-agent-physical-effect`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `proposals/ga-canary-20260521-210902/results/SIM-virim-child-manifested-embodiment-savepoint-receipts/device-bound-agent-physical-effect/openai-gpt-5.4-xhigh/20260521-210902.json`
...
### `proposals/ga-canary-20260521-210902/simulations/SIM-virim-child-manifested-embodiment-savepoint-receipts/README.md`

```markdown
# SIM-virim-child: Manifested embodiment savepoint receipts

This simulation breeds `SIM-nijuz-multi-embodiment-identity` and `SIM-kugap-live-sync-audit-split` into a more concrete worked profile.
...
Each actor keeps a small local ledger with:
- AM CID used
...
### `proposals/ga-canary-20260521-210902/simulations/SIM-virim-child-manifested-embodiment-savepoint-receipts/QUESTION.md`

```markdown
# Question

How can PromiseGrid teach a concrete v0 profile in which heterogeneous embodiments remain one logical app, publish honest partial-conformance claims, preserve signing-key continuity across browser and helper hosts, and publish durable audit milestones for off-grid live activity without pretending the live channel is already a PromiseGrid binding?

Open decision points:

- What minimum fields in the App Manifest and Embodiment Claim are required for third-party interop review?
- When browser and helper cannot co-sign an Identity Continuity Receipt, what witness or break-witness is sufficient?
- Should the Savepoint Audit Envelope normalize one cited-object shape, or allow snapshot, save-blob, receipt, and break-witness variants under one envelope schema?
- What minimum guide-safe wording should state that a hash is an address to content identity, not by itself a retention, authorization, or availability promise?
```

### `proposals/ga-canary-20260521-210902/simulations/SIM-virim-child-manifested-embodiment-savepoint-receipts/CLAIMS.md`
