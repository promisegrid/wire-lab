...
- Cell ID: `ga-canary-20260521-210902-000018-SIM-zisan-device-bound-agent--live-crdt-audit-publication--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-zisan-device-bound-agent`
- Scenario ID: `live-crdt-audit-publication`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-zisan-device-bound-agent/live-crdt-audit-publication/openai-gpt-5.4-xhigh/20260521-210902.json`
