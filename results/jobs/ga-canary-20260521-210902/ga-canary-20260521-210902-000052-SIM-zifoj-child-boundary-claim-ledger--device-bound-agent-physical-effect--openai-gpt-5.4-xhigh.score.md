...
- Cell ID: `ga-canary-20260521-210902-000052-SIM-zifoj-child-boundary-claim-ledger--device-bound-agent-physical-effect--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-zifoj-child-boundary-claim-ledger`
- Scenario ID: `device-bound-agent-physical-effect`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `proposals/ga-canary-20260521-210902/results/SIM-zifoj-child-boundary-claim-ledger/device-bound-agent-physical-effect/openai-gpt-5.4-xhigh/20260521-210902.json`
...
### `proposals/ga-canary-20260521-210902/simulations/SIM-zifoj-child-boundary-claim-ledger/README.md`

```markdown
# SIM-zifoj-child: Boundary claim ledger

This child combines the parent strengths on layer-boundary discipline and honest provisional conformance, then makes them more operational.

## Why this child exists

The parents are strong at saying what not to overclaim, but weak at giving a concrete claim package that Bob, Carol, and a future porter can actually inspect. This child adds a small auditable structure without pretending unsettled drafts are frozen.
...
### Delta 2: minimal promise-accounting ledger
Each actor keeps local rows for the promises they make, rely on, fail to meet, or witness failing. The ledger is lightweight but durable enough for later audit.
...
### `proposals/ga-canary-20260521-210902/simulations/SIM-zifoj-child-boundary-claim-ledger/QUESTION.md`
...
- Which ledger rows are mandatory for blob publish/retrieve, physical effects, audit snapshots, and key rotation?
...
### `proposals/ga-canary-20260521-210902/simulations/SIM-zifoj-child-boundary-claim-ledger/CLAIM-CARDS.md`
...
### `proposals/ga-canary-20260521-210902/simulations/SIM-zifoj-child-boundary-claim-ledger/LEDGER.md`

```markdown
# Minimal promise-accounting ledger
...
Bob's ledger row for returning a hash should state whether he promised only content identity or also any separate storage, discovery, retention, or authorization service. If none, it must say none.
...
- Host dependency failures are ledger events, not silent implementation detail.
