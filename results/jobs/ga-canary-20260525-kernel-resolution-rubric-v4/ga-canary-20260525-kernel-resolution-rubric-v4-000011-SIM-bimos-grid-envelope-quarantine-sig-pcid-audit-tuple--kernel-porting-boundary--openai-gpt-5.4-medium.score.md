...
- Cell ID: `ga-canary-20260525-kernel-resolution-rubric-v4-000011-SIM-bimos-grid-envelope-quarantine-sig-pcid-audit-tuple--kernel-porting-boundary--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-bimos-grid-envelope-quarantine-sig-pcid-audit-tuple/kernel-porting-boundary/openai-gpt-5.4-medium/20260525-152400.json`
