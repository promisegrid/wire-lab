...
- Cell ID: `ga-canary-20260525-kernel-resolution-rubric-v4-000007-SIM-funas-kernel-porting-boundary--minimal-immutable-blob-app--openai-gpt-5.4-medium`
- Simulation ID: `SIM-funas-kernel-porting-boundary`
- Scenario ID: `minimal-immutable-blob-app`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-funas-kernel-porting-boundary/minimal-immutable-blob-app/openai-gpt-5.4-medium/20260525-152400.json`
