...
- Cell ID: `ga-canary-20260525-kernel-resolution-rubric-v4-000014-SIM-bimos-grid-envelope-quarantine-sig-pcid-audit-tuple--live-crdt-audit-publication--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-bimos-grid-envelope-quarantine-sig-pcid-audit-tuple/live-crdt-audit-publication/openai-gpt-5.4-medium/20260525-152400.json`
