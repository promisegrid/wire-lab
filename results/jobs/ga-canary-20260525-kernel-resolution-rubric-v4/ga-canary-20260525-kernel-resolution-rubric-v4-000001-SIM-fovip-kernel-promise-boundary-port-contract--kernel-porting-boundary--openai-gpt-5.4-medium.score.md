...
- Cell ID: `ga-canary-20260525-kernel-resolution-rubric-v4-000001-SIM-fovip-kernel-promise-boundary-port-contract--kernel-porting-boundary--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-fovip-kernel-promise-boundary-port-contract/kernel-porting-boundary/openai-gpt-5.4-medium/20260525-152400.json`
