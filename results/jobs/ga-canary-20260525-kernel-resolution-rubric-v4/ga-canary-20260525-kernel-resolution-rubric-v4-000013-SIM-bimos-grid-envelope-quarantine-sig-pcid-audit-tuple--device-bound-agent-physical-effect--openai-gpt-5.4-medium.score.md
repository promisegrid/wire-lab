...
- Cell ID: `ga-canary-20260525-kernel-resolution-rubric-v4-000013-SIM-bimos-grid-envelope-quarantine-sig-pcid-audit-tuple--device-bound-agent-physical-effect--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-bimos-grid-envelope-quarantine-sig-pcid-audit-tuple/device-bound-agent-physical-effect/openai-gpt-5.4-medium/20260525-152400.json`
