...
- Run group ID: `ga-canary-20260520-221405`
- Cell ID: `ga-canary-20260520-221405-000008-SIM-gazan-grid-envelope-enc-cbor-unknown-hard-reject-sig-unsigned-v0--climate-coordination--openai-gpt-5.4-xhigh`
...
- Result path: `results/SIM-gazan-grid-envelope-enc-cbor-unknown-hard-reject-sig-unsigned-v0/climate-coordination/openai-gpt-5.4-xhigh/20260520-221405.json`
...
```markdown
# SIM-gazan-grid-envelope-enc-cbor-unknown-hard-reject-sig-unsigned-v0: Grid-envelope variant

This simulation is a standalone positional grid-envelope specimen. It tests the
combination `enc-cbor`, `unknown-hard-reject`, and `sig-unsigned-v0` without claiming
...
### `simulations/SIM-gazan-grid-envelope-enc-cbor-unknown-hard-reject-sig-unsigned-v0/protocols/grid-envelope.d/CHANGELOG.md`
...
> Variant: `enc-cbor` / `unknown-hard-reject` / `sig-unsigned-v0`.
> Source: `DI-fanah`.

## Purpose

This spec defines one full positional grid-envelope candidate for wire-lab
comparison. It is a specimen inside `SIM-gazan-grid-envelope-enc-cbor-unknown-hard-reject-sig-unsigned-v0`, not a harness rule and not the
...
- Source row/title: Seed application catalog entry `climate-coordination`
- Source DI / TODO / TE: `DI-faros`; `DI-vabor`; `DI-botup`; `DI-midif`; `TODO-dadub`

## Purpose

Exercise PromiseGrid design candidates against climate-coordination application
pressure: Global coordination of mitigation/adaptation efforts, funding promises,
measurements, and accountability.

## Setup

Alice depends on an outcome in the Climate Coordination domain. Bob makes promises about
global coordination of mitigation/adaptation efforts, funding promises, measurements,
and accountability. Carol needs enough evidence to rely on Bob's promise without having
