...
- Cell ID: `ga-canary-20260520-221405-000003-SIM-guhor-grid-envelope-enc-cbor-unknown-best-effort-sig-mandatory-opaque-bytes--cas-backed-group-session-group-visible-identity--openai-gpt-5.4-xhigh`
...
- Result path: `results/SIM-guhor-grid-envelope-enc-cbor-unknown-best-effort-sig-mandatory-opaque-bytes/cas-backed-group-session-group-visible-identity/openai-gpt-5.4-xhigh/20260520-221405.json`
