...
- Cell ID: `ga-canary-20260520-221405-000006-SIM-vutar-grid-envelope-enc-cbor-unknown-opaque-sig-mandatory-opaque-bytes--cas-backed-group-session-group-visible-identity--openai-gpt-5.4-xhigh`
...
- Result path: `results/SIM-vutar-grid-envelope-enc-cbor-unknown-opaque-sig-mandatory-opaque-bytes/cas-backed-group-session-group-visible-identity/openai-gpt-5.4-xhigh/20260520-221405.json`
