...
- Cell ID: `ga-canary-20260520-221405-000009-SIM-gazan-grid-envelope-enc-cbor-unknown-hard-reject-sig-unsigned-v0--cas-backed-group-session-group-visible-identity--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-gazan-grid-envelope-enc-cbor-unknown-hard-reject-sig-unsigned-v0`
- Scenario ID: `cas-backed-group-session-group-visible-identity`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-gazan-grid-envelope-enc-cbor-unknown-hard-reject-sig-unsigned-v0/cas-backed-group-session-group-visible-identity/openai-gpt-5.4-xhigh/20260520-221405.json`
...
### `scenarios/cas-backed-group-session-group-visible-identity/cas-backed-group-session-group-visible-identity.md`
