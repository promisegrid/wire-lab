...
- Cell ID: `ga-canary-20260520-221405-000007-SIM-gazan-grid-envelope-enc-cbor-unknown-hard-reject-sig-unsigned-v0--promise-accounting-records-corrupt-data--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-gazan-grid-envelope-enc-cbor-unknown-hard-reject-sig-unsigned-v0`
- Scenario ID: `promise-accounting-records-corrupt-data`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-gazan-grid-envelope-enc-cbor-unknown-hard-reject-sig-unsigned-v0/promise-accounting-records-corrupt-data/openai-gpt-5.4-xhigh/20260520-221405.json`
...
### `scenarios/promise-accounting-records-corrupt-data/promise-accounting-records-corrupt-data.md`
