...
- Cell ID: `ga-canary-20260524-pt-gate-v3-successors-plus-dalor-000062-SIM-vuliv-scoped-promise-evidence-records--group-session-freeze-promise-post-freeze-mutation-request--openai-gpt-5.4-medium`
- Simulation ID: `SIM-vuliv-scoped-promise-evidence-records`
- Scenario ID: `group-session-freeze-promise-post-freeze-mutation-request`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-vuliv-scoped-promise-evidence-records/group-session-freeze-promise-post-freeze-mutation-request/openai-gpt-5.4-medium/20260524-070634.json`
...
### `simulations/SIM-vuliv-scoped-promise-evidence-records/README.md`
...
### `simulations/SIM-vuliv-scoped-promise-evidence-records/QUESTION.md`

```markdown
# Question

Should PromiseGrid apps publish scoped promise-evidence records—promises,
promise references, and observed keep/break records—instead of scoped claim
cards, so later peers can audit local trust decisions without treating the
artifact itself as authority?
