...
- Cell ID: `ga-canary-20260524-pt-gate-v3-successors-plus-dalor-000048-SIM-padin-group-session-freeze-evidence--promise-economy-spectrum-permissioned-capability-token--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-padin-group-session-freeze-evidence/promise-economy-spectrum-permissioned-capability-token/openai-gpt-5.4-medium/20260524-070634.json`
