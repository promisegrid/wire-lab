...
- Cell ID: `ga-canary-20260524-pt-gate-v3-successors-plus-dalor-000053-SIM-natim-grid-envelope-nested-payload-outer-attestation-multisig--peer-adoption-metadata-relationship-scoped-adoption--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-natim-grid-envelope-nested-payload-outer-attestation-multisig/peer-adoption-metadata-relationship-scoped-adoption/openai-gpt-5.4-medium/20260524-070634.json`
