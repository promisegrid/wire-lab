...
- Cell ID: `ga-canary-20260524-pt-gate-v3-successors-plus-dalor-000001-SIM-pobod-grid-envelope-outer-promise-nested-signed-payload--promise-economy-spectrum-peer-local-assessment-only--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-pobod-grid-envelope-outer-promise-nested-signed-payload/promise-economy-spectrum-peer-local-assessment-only/openai-gpt-5.4-medium/20260524-070634.json`
