...
- Cell ID: `ga-canary-20260524-pt-gate-v3-successors-plus-dalor-000012-SIM-dutam-grid-envelope-fixed-header-variable-body--conditional-release-geofencing-onward-restraint-chain--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-dutam-grid-envelope-fixed-header-variable-body/conditional-release-geofencing-onward-restraint-chain/openai-gpt-5.4-medium/20260524-070634.json`
