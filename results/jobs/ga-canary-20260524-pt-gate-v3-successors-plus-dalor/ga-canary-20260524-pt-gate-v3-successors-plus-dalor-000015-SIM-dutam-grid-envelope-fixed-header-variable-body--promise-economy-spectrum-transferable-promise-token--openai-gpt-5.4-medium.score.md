...
- Cell ID: `ga-canary-20260524-pt-gate-v3-successors-plus-dalor-000015-SIM-dutam-grid-envelope-fixed-header-variable-body--promise-economy-spectrum-transferable-promise-token--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-dutam-grid-envelope-fixed-header-variable-body/promise-economy-spectrum-transferable-promise-token/openai-gpt-5.4-medium/20260524-070634.json`
