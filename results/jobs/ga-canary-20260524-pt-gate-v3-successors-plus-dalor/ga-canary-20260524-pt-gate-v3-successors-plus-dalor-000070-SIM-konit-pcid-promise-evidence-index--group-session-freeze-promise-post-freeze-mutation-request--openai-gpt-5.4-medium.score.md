...
- Cell ID: `ga-canary-20260524-pt-gate-v3-successors-plus-dalor-000070-SIM-konit-pcid-promise-evidence-index--group-session-freeze-promise-post-freeze-mutation-request--openai-gpt-5.4-medium`
- Simulation ID: `SIM-konit-pcid-promise-evidence-index`
- Scenario ID: `group-session-freeze-promise-post-freeze-mutation-request`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-konit-pcid-promise-evidence-index/group-session-freeze-promise-post-freeze-mutation-request/openai-gpt-5.4-medium/20260524-070634.json`
...
### `simulations/SIM-konit-pcid-promise-evidence-index/README.md`
...
### `simulations/SIM-konit-pcid-promise-evidence-index/QUESTION.md`

```markdown
# Question

Is a pCID-scoped promise-evidence index—a durable list of who promised what,
what evidence object supports it, and what later happened—a better PromiseGrid
pattern than a scoped conformance citation ledger?
