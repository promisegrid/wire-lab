...
- Cell ID: `ga-canary-20260524-pt-gate-v3-successors-plus-dalor-000065-SIM-konit-pcid-promise-evidence-index--promise-economy-spectrum-peer-local-assessment-only--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-konit-pcid-promise-evidence-index/promise-economy-spectrum-peer-local-assessment-only/openai-gpt-5.4-medium/20260524-070634.json`
