...
- Cell ID: `ga-canary-20260524-pt-gate-v3-successors-plus-dalor-000022-SIM-dalor-grid-envelope-protocol-owned-signature-slot--group-session-freeze-promise-post-freeze-mutation-request--openai-gpt-5.4-medium`
- Simulation ID: `SIM-dalor-grid-envelope-protocol-owned-signature-slot`
- Scenario ID: `group-session-freeze-promise-post-freeze-mutation-request`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-dalor-grid-envelope-protocol-owned-signature-slot/group-session-freeze-promise-post-freeze-mutation-request/openai-gpt-5.4-medium/20260524-070634.json`
