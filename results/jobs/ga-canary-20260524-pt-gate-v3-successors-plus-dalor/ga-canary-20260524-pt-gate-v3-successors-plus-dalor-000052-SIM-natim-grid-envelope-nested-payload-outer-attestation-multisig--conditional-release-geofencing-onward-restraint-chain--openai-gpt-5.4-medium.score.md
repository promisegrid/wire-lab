...
- Cell ID: `ga-canary-20260524-pt-gate-v3-successors-plus-dalor-000052-SIM-natim-grid-envelope-nested-payload-outer-attestation-multisig--conditional-release-geofencing-onward-restraint-chain--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-natim-grid-envelope-nested-payload-outer-attestation-multisig/conditional-release-geofencing-onward-restraint-chain/openai-gpt-5.4-medium/20260524-070634.json`
