...
- Cell ID: `ga-canary-20260520-221953-000012-SIM-bimos-ga-child-0001--cas-object-type-binding-bakeoff-application-object-family--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-bimos-ga-child-0001`
- Scenario ID: `cas-object-type-binding-bakeoff-application-object-family`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-bimos-ga-child-0001/cas-object-type-binding-bakeoff-application-object-family/openai-gpt-5.4-xhigh/20260520-221953.json`
...
### `simulations/SIM-bimos-ga-child-0001/README.md`

```markdown
# SIM-bimos-ga-child-0001: Grid-envelope variant
...
This child is expected to improve on the parents under mixed-version IoT fleets, route-evidence exchange, and future CAS object-family rollout because unknown envelopes are not silently accepted, but they also are not needlessly discarded.

The local draft spec is `protocols/grid-envelope.d/specs/grid-envelope-draft.md`.
```

### `simulations/SIM-bimos-ga-child-0001/QUESTION.md`
...
### `simulations/SIM-bimos-ga-child-0001/protocols/grid-envelope.d/CHANGELOG.md`
...
- Created child specimen `SIM-bimos-ga-child-0001`.
- Bred from:
...
### `simulations/SIM-bimos-ga-child-0001/protocols/grid-envelope.d/specs/grid-envelope-draft.md`
...
> Bred from two simulation-local parent specimens. Source lineage: `DI-fanah` plus GA child synthesis.

## Purpose

This spec defines one full positional grid-envelope candidate for wire-lab
comparison. It is a specimen inside `SIM-bimos-ga-child-0001`, not a harness rule
