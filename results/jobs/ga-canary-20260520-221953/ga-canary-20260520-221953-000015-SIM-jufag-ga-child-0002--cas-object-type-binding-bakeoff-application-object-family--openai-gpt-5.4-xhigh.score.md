...
- Cell ID: `ga-canary-20260520-221953-000015-SIM-jufag-ga-child-0002--cas-object-type-binding-bakeoff-application-object-family--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-jufag-ga-child-0002`
- Scenario ID: `cas-object-type-binding-bakeoff-application-object-family`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-jufag-ga-child-0002/cas-object-type-binding-bakeoff-application-object-family/openai-gpt-5.4-xhigh/20260520-221953.json`
...
### `simulations/SIM-jufag-ga-child-0002/README.md`

```markdown
# SIM-jufag-ga-child-0002: Grid-envelope variant
...
### `simulations/SIM-jufag-ga-child-0002/QUESTION.md`

```markdown
# Question

Does a positional grid envelope using `enc-dag-cbor`, `unknown-quarantine`, and `sig-mandatory-profiled-opaque-bytes` satisfy the sampled wire-lab scenarios better than both parents by preserving unknown future objects as auditable evidence while fail-closing semantic acceptance and naming signature verification rules explicitly?
```

### `simulations/SIM-jufag-ga-child-0002/protocols/grid-envelope.d/CHANGELOG.md`
...
Initial child draft for `SIM-jufag-ga-child-0002`, bred from:
...
### `simulations/SIM-jufag-ga-child-0002/protocols/grid-envelope.d/specs/grid-envelope-draft.md`
...
> Source: `DI-fanah`; GA child bred from the two parent specimens named in `README.md`.
...
This is a specimen inside `SIM-jufag-ga-child-0002`, not a harness rule and not the canonical PromiseGrid wire format.
