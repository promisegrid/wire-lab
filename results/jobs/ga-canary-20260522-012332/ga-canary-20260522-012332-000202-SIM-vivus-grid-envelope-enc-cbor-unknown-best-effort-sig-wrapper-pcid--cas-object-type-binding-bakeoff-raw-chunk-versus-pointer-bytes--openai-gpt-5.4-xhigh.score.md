...
- Cell ID: `ga-canary-20260522-012332-000202-SIM-vivus-grid-envelope-enc-cbor-unknown-best-effort-sig-wrapper-pcid--cas-object-type-binding-bakeoff-raw-chunk-versus-pointer-bytes--openai-gpt-5.4-xhigh`
...
- Result path: `results/SIM-vivus-grid-envelope-enc-cbor-unknown-best-effort-sig-wrapper-pcid/cas-object-type-binding-bakeoff-raw-chunk-versus-pointer-bytes/openai-gpt-5.4-xhigh/20260522-012332.json`
...
### `simulations/SIM-vivus-grid-envelope-enc-cbor-unknown-best-effort-sig-wrapper-pcid/README.md`

```markdown
# SIM-vivus-grid-envelope-enc-cbor-unknown-best-effort-sig-wrapper-pcid: Grid-envelope variant

This simulation is a standalone positional grid-envelope specimen. It tests the
combination `enc-cbor`, `unknown-best-effort`, and `sig-wrapper-pcid` without claiming
...
### `simulations/SIM-vivus-grid-envelope-enc-cbor-unknown-best-effort-sig-wrapper-pcid/QUESTION.md`
...
### `simulations/SIM-vivus-grid-envelope-enc-cbor-unknown-best-effort-sig-wrapper-pcid/protocols/grid-envelope.d/CHANGELOG.md`
...
### `simulations/SIM-vivus-grid-envelope-enc-cbor-unknown-best-effort-sig-wrapper-pcid/protocols/grid-envelope.d/specs/grid-envelope-draft.md`

```markdown
# Grid Envelope Variant Spec (DRAFT)

> **Status: DRAFT.** Not frozen. The pCID for this spec is not yet minted.
> Variant: `enc-cbor` / `unknown-best-effort` / `sig-wrapper-pcid`.
> Source: `DI-fanah`.

## Purpose

This spec defines one full positional grid-envelope candidate for wire-lab
comparison. It is a specimen inside `SIM-vivus-grid-envelope-enc-cbor-unknown-best-effort-sig-wrapper-pcid`, not a harness rule and not the
