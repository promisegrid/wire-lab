...
- Cell ID: `ga-canary-20260522-012332-000221-SIM-zifik-grid-envelope-enc-dag-cbor-unknown-best-effort-sig-unsigned-v0--conditional-release-geofencing-opaque-lower-layer-carriage--openai-gpt-5.4-xhigh`
...
- Result path: `results/SIM-zifik-grid-envelope-enc-dag-cbor-unknown-best-effort-sig-unsigned-v0/conditional-release-geofencing-opaque-lower-layer-carriage/openai-gpt-5.4-xhigh/20260522-012332.json`
