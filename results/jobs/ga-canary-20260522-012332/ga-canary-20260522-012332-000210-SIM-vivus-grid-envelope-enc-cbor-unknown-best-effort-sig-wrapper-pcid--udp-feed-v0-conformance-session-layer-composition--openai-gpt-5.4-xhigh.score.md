...
- Cell ID: `ga-canary-20260522-012332-000210-SIM-vivus-grid-envelope-enc-cbor-unknown-best-effort-sig-wrapper-pcid--udp-feed-v0-conformance-session-layer-composition--openai-gpt-5.4-xhigh`
...
- Result path: `results/SIM-vivus-grid-envelope-enc-cbor-unknown-best-effort-sig-wrapper-pcid/udp-feed-v0-conformance-session-layer-composition/openai-gpt-5.4-xhigh/20260522-012332.json`
