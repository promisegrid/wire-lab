...
- Cell ID: `ga-canary-20260522-012332-000168-SIM-riliz-grid-envelope-enc-dag-cbor-unknown-opaque-sig-mandatory-sig-pcid-payload--bgp-class-routing-app-route-leak--openai-gpt-5.4-xhigh`
...
- Result path: `results/SIM-riliz-grid-envelope-enc-dag-cbor-unknown-opaque-sig-mandatory-sig-pcid-payload/bgp-class-routing-app-route-leak/openai-gpt-5.4-xhigh/20260522-012332.json`
