...
- Cell ID: `ga-canary-20260522-012332-000123-SIM-kurim-grid-envelope--bgp-class-routing-app-route-leak--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-kurim-grid-envelope`
- Scenario ID: `bgp-class-routing-app-route-leak`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-kurim-grid-envelope/bgp-class-routing-app-route-leak/openai-gpt-5.4-xhigh/20260522-012332.json`
