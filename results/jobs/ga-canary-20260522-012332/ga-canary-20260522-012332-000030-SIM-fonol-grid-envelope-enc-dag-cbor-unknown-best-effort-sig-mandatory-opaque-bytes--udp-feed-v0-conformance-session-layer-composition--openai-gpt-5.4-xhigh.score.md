...
- Cell ID: `ga-canary-20260522-012332-000030-SIM-fonol-grid-envelope-enc-dag-cbor-unknown-best-effort-sig-mandatory-opaque-bytes--udp-feed-v0-conformance-session-layer-composition--openai-gpt-5.4-xhigh`
...
- Result path: `results/SIM-fonol-grid-envelope-enc-dag-cbor-unknown-best-effort-sig-mandatory-opaque-bytes/udp-feed-v0-conformance-session-layer-composition/openai-gpt-5.4-xhigh/20260522-012332.json`
