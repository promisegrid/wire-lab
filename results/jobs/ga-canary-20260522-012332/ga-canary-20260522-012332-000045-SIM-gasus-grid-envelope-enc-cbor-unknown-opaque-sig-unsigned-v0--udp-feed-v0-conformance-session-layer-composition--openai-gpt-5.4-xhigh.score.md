...
- Cell ID: `ga-canary-20260522-012332-000045-SIM-gasus-grid-envelope-enc-cbor-unknown-opaque-sig-unsigned-v0--udp-feed-v0-conformance-session-layer-composition--openai-gpt-5.4-xhigh`
...
- Result path: `results/SIM-gasus-grid-envelope-enc-cbor-unknown-opaque-sig-unsigned-v0/udp-feed-v0-conformance-session-layer-composition/openai-gpt-5.4-xhigh/20260522-012332.json`
