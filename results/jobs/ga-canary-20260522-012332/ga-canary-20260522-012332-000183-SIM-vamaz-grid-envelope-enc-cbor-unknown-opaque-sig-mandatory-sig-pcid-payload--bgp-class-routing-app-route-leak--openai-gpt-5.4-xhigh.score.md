...
- Cell ID: `ga-canary-20260522-012332-000183-SIM-vamaz-grid-envelope-enc-cbor-unknown-opaque-sig-mandatory-sig-pcid-payload--bgp-class-routing-app-route-leak--openai-gpt-5.4-xhigh`
...
- Result path: `results/SIM-vamaz-grid-envelope-enc-cbor-unknown-opaque-sig-mandatory-sig-pcid-payload/bgp-class-routing-app-route-leak/openai-gpt-5.4-xhigh/20260522-012332.json`
