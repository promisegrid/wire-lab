...
- Cell ID: `ga-canary-20260522-012332-000033-SIM-gasus-grid-envelope-enc-cbor-unknown-opaque-sig-unsigned-v0--bgp-class-routing-app-route-leak--openai-gpt-5.4-xhigh`
...
- Result path: `results/SIM-gasus-grid-envelope-enc-cbor-unknown-opaque-sig-unsigned-v0/bgp-class-routing-app-route-leak/openai-gpt-5.4-xhigh/20260522-012332.json`
