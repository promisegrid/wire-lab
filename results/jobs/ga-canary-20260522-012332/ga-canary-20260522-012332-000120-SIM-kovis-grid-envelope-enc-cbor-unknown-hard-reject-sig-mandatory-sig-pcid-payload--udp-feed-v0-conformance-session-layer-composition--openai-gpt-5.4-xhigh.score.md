...
- Cell ID: `ga-canary-20260522-012332-000120-SIM-kovis-grid-envelope-enc-cbor-unknown-hard-reject-sig-mandatory-sig-pcid-payload--udp-feed-v0-conformance-session-layer-composition--openai-gpt-5.4-xhigh`
...
- Result path: `results/SIM-kovis-grid-envelope-enc-cbor-unknown-hard-reject-sig-mandatory-sig-pcid-payload/udp-feed-v0-conformance-session-layer-composition/openai-gpt-5.4-xhigh/20260522-012332.json`
