...
- Cell ID: `ga-canary-20260522-012332-000215-SIM-zifik-grid-envelope-enc-dag-cbor-unknown-best-effort-sig-unsigned-v0--cas-backed-group-session-envelope-independence--openai-gpt-5.4-xhigh`
...
- Result path: `results/SIM-zifik-grid-envelope-enc-dag-cbor-unknown-best-effort-sig-unsigned-v0/cas-backed-group-session-envelope-independence/openai-gpt-5.4-xhigh/20260522-012332.json`
