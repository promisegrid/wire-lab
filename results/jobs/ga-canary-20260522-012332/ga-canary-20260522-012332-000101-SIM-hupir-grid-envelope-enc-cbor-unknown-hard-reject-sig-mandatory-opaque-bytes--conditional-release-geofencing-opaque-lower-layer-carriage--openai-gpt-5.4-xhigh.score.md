...
- Cell ID: `ga-canary-20260522-012332-000101-SIM-hupir-grid-envelope-enc-cbor-unknown-hard-reject-sig-mandatory-opaque-bytes--conditional-release-geofencing-opaque-lower-layer-carriage--openai-gpt-5.4-xhigh`
...
- Result path: `results/SIM-hupir-grid-envelope-enc-cbor-unknown-hard-reject-sig-mandatory-opaque-bytes/conditional-release-geofencing-opaque-lower-layer-carriage/openai-gpt-5.4-xhigh/20260522-012332.json`
