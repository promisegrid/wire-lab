...
- Cell ID: `ga-canary-20260522-012332-000135-SIM-kurim-grid-envelope--udp-feed-v0-conformance-session-layer-composition--openai-gpt-5.4-xhigh`
...
- Result path: `results/SIM-kurim-grid-envelope/udp-feed-v0-conformance-session-layer-composition/openai-gpt-5.4-xhigh/20260522-012332.json`
