...
- Cell ID: `ga-canary-20260522-012332-000142-SIM-mahih-grid-envelope-enc-cbor-unknown-opaque-sig-wrapper-pcid--cas-object-type-binding-bakeoff-raw-chunk-versus-pointer-bytes--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-mahih-grid-envelope-enc-cbor-unknown-opaque-sig-wrapper-pcid`
- Scenario ID: `cas-object-type-binding-bakeoff-raw-chunk-versus-pointer-bytes`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-mahih-grid-envelope-enc-cbor-unknown-opaque-sig-wrapper-pcid/cas-object-type-binding-bakeoff-raw-chunk-versus-pointer-bytes/openai-gpt-5.4-xhigh/20260522-012332.json`
...
### `simulations/SIM-mahih-grid-envelope-enc-cbor-unknown-opaque-sig-wrapper-pcid/README.md`

```markdown
# SIM-mahih-grid-envelope-enc-cbor-unknown-opaque-sig-wrapper-pcid: Grid-envelope variant

This simulation is a standalone positional grid-envelope specimen. It tests the
combination `enc-cbor`, `unknown-opaque`, and `sig-wrapper-pcid` without claiming
...
### `simulations/SIM-mahih-grid-envelope-enc-cbor-unknown-opaque-sig-wrapper-pcid/QUESTION.md`
...
### `simulations/SIM-mahih-grid-envelope-enc-cbor-unknown-opaque-sig-wrapper-pcid/protocols/grid-envelope.d/CHANGELOG.md`
...
### `simulations/SIM-mahih-grid-envelope-enc-cbor-unknown-opaque-sig-wrapper-pcid/protocols/grid-envelope.d/specs/grid-envelope-draft.md`
