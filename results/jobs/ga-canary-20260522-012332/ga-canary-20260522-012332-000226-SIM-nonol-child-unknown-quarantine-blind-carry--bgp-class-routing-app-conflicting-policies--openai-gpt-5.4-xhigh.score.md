...
- Cell ID: `ga-canary-20260522-012332-000226-SIM-nonol-child-unknown-quarantine-blind-carry--bgp-class-routing-app-conflicting-policies--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-nonol-child-unknown-quarantine-blind-carry`
- Scenario ID: `bgp-class-routing-app-conflicting-policies`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `proposals/ga-canary-20260522-012332/results/SIM-nonol-child-unknown-quarantine-blind-carry/bgp-class-routing-app-conflicting-policies/openai-gpt-5.4-xhigh/20260522-012332.json`
