...
- Cell ID: `ga-canary-20260522-012332-000134-SIM-kurim-grid-envelope--udp-feed-v0-conformance-malformed-datagram--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-kurim-grid-envelope`
- Scenario ID: `udp-feed-v0-conformance-malformed-datagram`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-kurim-grid-envelope/udp-feed-v0-conformance-malformed-datagram/openai-gpt-5.4-xhigh/20260522-012332.json`
