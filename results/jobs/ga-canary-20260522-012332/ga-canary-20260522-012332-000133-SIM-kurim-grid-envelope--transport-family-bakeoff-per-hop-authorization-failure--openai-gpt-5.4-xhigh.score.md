...
- Cell ID: `ga-canary-20260522-012332-000133-SIM-kurim-grid-envelope--transport-family-bakeoff-per-hop-authorization-failure--openai-gpt-5.4-xhigh`
...
- Result path: `results/SIM-kurim-grid-envelope/transport-family-bakeoff-per-hop-authorization-failure/openai-gpt-5.4-xhigh/20260522-012332.json`
