...
- Cell ID: `ga-canary-20260522-012332-000035-SIM-gasus-grid-envelope-enc-cbor-unknown-opaque-sig-unsigned-v0--cas-backed-group-session-envelope-independence--openai-gpt-5.4-xhigh`
...
- Result path: `results/SIM-gasus-grid-envelope-enc-cbor-unknown-opaque-sig-unsigned-v0/cas-backed-group-session-envelope-independence/openai-gpt-5.4-xhigh/20260522-012332.json`
