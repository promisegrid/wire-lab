...
- Cell ID: `ga-canary-20260522-012332-000124-SIM-kurim-grid-envelope--bgp-class-routing-app-sparse-knowledge--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-kurim-grid-envelope`
- Scenario ID: `bgp-class-routing-app-sparse-knowledge`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-kurim-grid-envelope/bgp-class-routing-app-sparse-knowledge/openai-gpt-5.4-xhigh/20260522-012332.json`
