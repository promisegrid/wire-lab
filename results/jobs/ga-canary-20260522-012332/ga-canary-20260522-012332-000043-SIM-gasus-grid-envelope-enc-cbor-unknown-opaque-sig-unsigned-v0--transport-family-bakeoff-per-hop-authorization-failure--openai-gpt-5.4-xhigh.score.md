...
- Cell ID: `ga-canary-20260522-012332-000043-SIM-gasus-grid-envelope-enc-cbor-unknown-opaque-sig-unsigned-v0--transport-family-bakeoff-per-hop-authorization-failure--openai-gpt-5.4-xhigh`
...
- Result path: `results/SIM-gasus-grid-envelope-enc-cbor-unknown-opaque-sig-unsigned-v0/transport-family-bakeoff-per-hop-authorization-failure/openai-gpt-5.4-xhigh/20260522-012332.json`
