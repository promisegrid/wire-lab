...
- Cell ID: `ga-canary-20260522-012332-000048-SIM-gojot-grid-envelope-enc-dag-cbor-unknown-opaque-sig-wrapper-pcid--bgp-class-routing-app-route-leak--openai-gpt-5.4-xhigh`
...
- Result path: `results/SIM-gojot-grid-envelope-enc-dag-cbor-unknown-opaque-sig-wrapper-pcid/bgp-class-routing-app-route-leak/openai-gpt-5.4-xhigh/20260522-012332.json`
