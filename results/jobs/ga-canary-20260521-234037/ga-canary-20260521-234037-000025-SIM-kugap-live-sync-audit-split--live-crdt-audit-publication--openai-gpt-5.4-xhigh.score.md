...
- Cell ID: `ga-canary-20260521-234037-000025-SIM-kugap-live-sync-audit-split--live-crdt-audit-publication--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-kugap-live-sync-audit-split`
- Scenario ID: `live-crdt-audit-publication`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-kugap-live-sync-audit-split/live-crdt-audit-publication/openai-gpt-5.4-xhigh/20260521-234037.json`
