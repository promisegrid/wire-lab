...
- Cell ID: `ga-canary-20260521-234037-000024-SIM-kugap-live-sync-audit-split--device-bound-agent-physical-effect--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-kugap-live-sync-audit-split`
- Scenario ID: `device-bound-agent-physical-effect`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-kugap-live-sync-audit-split/device-bound-agent-physical-effect/openai-gpt-5.4-xhigh/20260521-234037.json`
