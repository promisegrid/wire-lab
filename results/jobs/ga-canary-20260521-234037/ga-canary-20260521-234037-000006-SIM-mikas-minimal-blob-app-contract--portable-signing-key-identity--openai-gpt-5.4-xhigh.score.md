...
- Cell ID: `ga-canary-20260521-234037-000006-SIM-mikas-minimal-blob-app-contract--portable-signing-key-identity--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-mikas-minimal-blob-app-contract`
- Scenario ID: `portable-signing-key-identity`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-mikas-minimal-blob-app-contract/portable-signing-key-identity/openai-gpt-5.4-xhigh/20260521-234037.json`
