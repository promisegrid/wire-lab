...
- Cell ID: `ga-canary-20260521-234037-000026-SIM-kugap-live-sync-audit-split--multi-embodiment-app-identity--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-kugap-live-sync-audit-split`
- Scenario ID: `multi-embodiment-app-identity`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-kugap-live-sync-audit-split/multi-embodiment-app-identity/openai-gpt-5.4-xhigh/20260521-234037.json`
