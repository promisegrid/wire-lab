...
- Cell ID: `ga-canary-20260521-234037-000007-SIM-mikas-minimal-blob-app-contract--kernel-porting-boundary--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-mikas-minimal-blob-app-contract`
- Scenario ID: `kernel-porting-boundary`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-mikas-minimal-blob-app-contract/kernel-porting-boundary/openai-gpt-5.4-xhigh/20260521-234037.json`
