...
- Cell ID: `ga-canary-20260521-234037-000022-SIM-kugap-live-sync-audit-split--minimal-immutable-blob-app--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-kugap-live-sync-audit-split`
- Scenario ID: `minimal-immutable-blob-app`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-kugap-live-sync-audit-split/minimal-immutable-blob-app/openai-gpt-5.4-xhigh/20260521-234037.json`
