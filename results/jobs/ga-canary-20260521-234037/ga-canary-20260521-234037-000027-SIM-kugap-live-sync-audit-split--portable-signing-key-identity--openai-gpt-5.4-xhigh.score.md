...
- Cell ID: `ga-canary-20260521-234037-000027-SIM-kugap-live-sync-audit-split--portable-signing-key-identity--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-kugap-live-sync-audit-split`
- Scenario ID: `portable-signing-key-identity`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-kugap-live-sync-audit-split/portable-signing-key-identity/openai-gpt-5.4-xhigh/20260521-234037.json`
