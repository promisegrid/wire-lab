...
- Cell ID: `ga-canary-20260521-234037-000023-SIM-kugap-live-sync-audit-split--app-semantics-partial-conformance--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-kugap-live-sync-audit-split`
- Scenario ID: `app-semantics-partial-conformance`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-kugap-live-sync-audit-split/app-semantics-partial-conformance/openai-gpt-5.4-xhigh/20260521-234037.json`
