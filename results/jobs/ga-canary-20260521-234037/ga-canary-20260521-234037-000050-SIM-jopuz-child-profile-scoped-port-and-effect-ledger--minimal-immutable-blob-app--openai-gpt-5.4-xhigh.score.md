...
- Cell ID: `ga-canary-20260521-234037-000050-SIM-jopuz-child-profile-scoped-port-and-effect-ledger--minimal-immutable-blob-app--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-jopuz-child-profile-scoped-port-and-effect-ledger`
- Scenario ID: `minimal-immutable-blob-app`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `proposals/ga-canary-20260521-234037/results/SIM-jopuz-child-profile-scoped-port-and-effect-ledger/minimal-immutable-blob-app/openai-gpt-5.4-xhigh/20260521-234037.json`
