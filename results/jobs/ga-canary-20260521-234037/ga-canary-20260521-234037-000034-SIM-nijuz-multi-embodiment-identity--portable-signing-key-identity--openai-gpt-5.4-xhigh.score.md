...
- Cell ID: `ga-canary-20260521-234037-000034-SIM-nijuz-multi-embodiment-identity--portable-signing-key-identity--openai-gpt-5.4-xhigh`
- Simulation ID: `SIM-nijuz-multi-embodiment-identity`
- Scenario ID: `portable-signing-key-identity`
- Model ID: `openai-gpt-5.4-xhigh`
- Result path: `results/SIM-nijuz-multi-embodiment-identity/portable-signing-key-identity/openai-gpt-5.4-xhigh/20260521-234037.json`
