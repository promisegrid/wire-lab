...
- Cell ID: `ga-tugoz-20260523-072345-000005-SIM-pamap-grid-envelope-signable-view-atproto-like--device-bound-agent-physical-effect--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-pamap-grid-envelope-signable-view-atproto-like/device-bound-agent-physical-effect/openai-gpt-5.4-medium/20260523-072404.json`
