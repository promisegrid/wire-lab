...
- Cell ID: `ga-tugoz-20260523-072345-000023-SIM-fitin-gordian-payload-wrapper--device-bound-agent-physical-effect--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-fitin-gordian-payload-wrapper/device-bound-agent-physical-effect/openai-gpt-5.4-medium/20260523-072404.json`
