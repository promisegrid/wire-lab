...
- Cell ID: `ga-tugoz-20260523-072345-000034-SIM-vizan-gordian-selective-disclosure--chunk-feed-replication-sparse-advertisement--openai-gpt-5.4-medium`
- Simulation ID: `SIM-vizan-gordian-selective-disclosure`
- Scenario ID: `chunk-feed-replication-sparse-advertisement`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-vizan-gordian-selective-disclosure/chunk-feed-replication-sparse-advertisement/openai-gpt-5.4-medium/20260523-072404.json`
...
### `simulations/SIM-vizan-gordian-selective-disclosure/README.md`

```markdown
# SIM-vizan-gordian-selective-disclosure: Gordian selective-disclosure probe

This simulation is a standalone grid-envelope specimen. It keeps the universal
outer grid minimal, but adds a Gordian-style payload/wrapper family that is
optimized for selective disclosure and reveal-pressure rather than only basic
subject/assertion/proof structure. Source: `DI-nohir`.

The local draft spec is
`protocols/grid-envelope.d/specs/grid-envelope-draft.md`.

Primary comparison targets: `SIM-fitin` and `SIM-suzuf`.
```

### `simulations/SIM-vizan-gordian-selective-disclosure/QUESTION.md`

```markdown
# Question

Does a Gordian-style selective-disclosure payload/wrapper family add enough
value for privacy and reveal-pressure scenarios to justify the extra structure,
or should PromiseGrid stay with simpler payload-local proof shapes? Source:
`DI-nohir`.
```

### `simulations/SIM-vizan-gordian-selective-disclosure/protocols/grid-envelope.d/specs/grid-envelope-draft.md`
