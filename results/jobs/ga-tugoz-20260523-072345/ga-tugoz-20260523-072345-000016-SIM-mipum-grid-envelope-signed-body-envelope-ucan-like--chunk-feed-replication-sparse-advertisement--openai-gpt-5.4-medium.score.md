...
- Cell ID: `ga-tugoz-20260523-072345-000016-SIM-mipum-grid-envelope-signed-body-envelope-ucan-like--chunk-feed-replication-sparse-advertisement--openai-gpt-5.4-medium`
- Simulation ID: `SIM-mipum-grid-envelope-signed-body-envelope-ucan-like`
- Scenario ID: `chunk-feed-replication-sparse-advertisement`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-mipum-grid-envelope-signed-body-envelope-ucan-like/chunk-feed-replication-sparse-advertisement/openai-gpt-5.4-medium/20260523-072404.json`
...
### `simulations/SIM-mipum-grid-envelope-signed-body-envelope-ucan-like/README.md`

```markdown
# SIM-mipum-grid-envelope-signed-body-envelope-ucan-like: UCAN-like signed-body envelope probe
...
explicitly separate a signed body from its proof material in one payload
envelope. Source: `DI-nohir`.

The local draft spec is
`protocols/grid-envelope.d/specs/grid-envelope-draft.md`.

Primary comparison targets: `SIM-riliz` and `SIM-pamap`.
```

### `simulations/SIM-mipum-grid-envelope-signed-body-envelope-ucan-like/QUESTION.md`

```markdown
# Question

Is a UCAN-like "signed body plus sibling proof material" payload contract a
better PromiseGrid shape than either universal outer proof slots or an
atproto-like reserved proof slot with an explicit signable view? Source:
`DI-nohir`.
```

### `simulations/SIM-mipum-grid-envelope-signed-body-envelope-ucan-like/protocols/grid-envelope.d/specs/grid-envelope-draft.md`
