...
- Cell ID: `ga-tugoz-20260523-072345-000024-SIM-fitin-gordian-payload-wrapper--minimal-immutable-blob-app--openai-gpt-5.4-medium`
- Simulation ID: `SIM-fitin-gordian-payload-wrapper`
- Scenario ID: `minimal-immutable-blob-app`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-fitin-gordian-payload-wrapper/minimal-immutable-blob-app/openai-gpt-5.4-medium/20260523-072404.json`
