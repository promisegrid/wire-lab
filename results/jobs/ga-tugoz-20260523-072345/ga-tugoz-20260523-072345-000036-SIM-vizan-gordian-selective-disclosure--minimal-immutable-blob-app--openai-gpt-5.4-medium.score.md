...
- Cell ID: `ga-tugoz-20260523-072345-000036-SIM-vizan-gordian-selective-disclosure--minimal-immutable-blob-app--openai-gpt-5.4-medium`
- Simulation ID: `SIM-vizan-gordian-selective-disclosure`
- Scenario ID: `minimal-immutable-blob-app`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-vizan-gordian-selective-disclosure/minimal-immutable-blob-app/openai-gpt-5.4-medium/20260523-072404.json`
