...
- Cell ID: `ga-tugoz-20260523-072345-000017-SIM-mipum-grid-envelope-signed-body-envelope-ucan-like--device-bound-agent-physical-effect--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-mipum-grid-envelope-signed-body-envelope-ucan-like/device-bound-agent-physical-effect/openai-gpt-5.4-medium/20260523-072404.json`
