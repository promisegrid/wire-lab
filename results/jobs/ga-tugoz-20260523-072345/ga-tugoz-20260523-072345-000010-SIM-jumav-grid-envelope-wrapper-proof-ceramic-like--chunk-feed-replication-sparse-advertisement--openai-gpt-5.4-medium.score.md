...
- Cell ID: `ga-tugoz-20260523-072345-000010-SIM-jumav-grid-envelope-wrapper-proof-ceramic-like--chunk-feed-replication-sparse-advertisement--openai-gpt-5.4-medium`
- Simulation ID: `SIM-jumav-grid-envelope-wrapper-proof-ceramic-like`
- Scenario ID: `chunk-feed-replication-sparse-advertisement`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-jumav-grid-envelope-wrapper-proof-ceramic-like/chunk-feed-replication-sparse-advertisement/openai-gpt-5.4-medium/20260523-072404.json`
...
### `simulations/SIM-jumav-grid-envelope-wrapper-proof-ceramic-like/README.md`
...
### `simulations/SIM-jumav-grid-envelope-wrapper-proof-ceramic-like/QUESTION.md`

```markdown
# Question

Should PromiseGrid prefer a Ceramic-like proof wrapper selected by the payload
pCID, where the wrapper signs linked content rather than carrying a proof in the
same payload bytes, when the goal is to keep the universal outer grid tiny and
avoid self-referential signing rules? Source: `DI-nohir`.
```

### `simulations/SIM-jumav-grid-envelope-wrapper-proof-ceramic-like/protocols/grid-envelope.d/specs/grid-envelope-draft.md`
