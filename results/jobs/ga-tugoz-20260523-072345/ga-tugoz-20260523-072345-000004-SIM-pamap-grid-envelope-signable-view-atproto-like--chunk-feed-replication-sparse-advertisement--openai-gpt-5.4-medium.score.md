...
- Cell ID: `ga-tugoz-20260523-072345-000004-SIM-pamap-grid-envelope-signable-view-atproto-like--chunk-feed-replication-sparse-advertisement--openai-gpt-5.4-medium`
- Simulation ID: `SIM-pamap-grid-envelope-signable-view-atproto-like`
- Scenario ID: `chunk-feed-replication-sparse-advertisement`
- Model ID: `openai-gpt-5.4-medium`
- Result path: `results/SIM-pamap-grid-envelope-signable-view-atproto-like/chunk-feed-replication-sparse-advertisement/openai-gpt-5.4-medium/20260523-072404.json`
...
### `simulations/SIM-pamap-grid-envelope-signable-view-atproto-like/README.md`
...
### `simulations/SIM-pamap-grid-envelope-signable-view-atproto-like/protocols/grid-envelope.d/specs/grid-envelope-draft.md`
