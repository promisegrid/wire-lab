...
- Cell ID: `ga-tugoz-20260523-072345-000011-SIM-jumav-grid-envelope-wrapper-proof-ceramic-like--device-bound-agent-physical-effect--openai-gpt-5.4-medium`
...
- Result path: `results/SIM-jumav-grid-envelope-wrapper-proof-ceramic-like/device-bound-agent-physical-effect/openai-gpt-5.4-medium/20260523-072404.json`
