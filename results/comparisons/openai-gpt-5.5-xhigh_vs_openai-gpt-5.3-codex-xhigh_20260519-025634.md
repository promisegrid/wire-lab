...
- Comparison run timestamp: `20260519-025634`
- Cells compared: `28`
- Verdict text changes: `0`
- Score/rank changes: `0`
...
| `SIM-vamaz-grid-envelope-enc-cbor-unknown-opaque-sig-mandatory-sig-pcid-payload` | 5.67 | 2 | 5.67 | 2 | +0 |
...
|---|---|---|---|---:|
| `SIM-gazan-grid-envelope-enc-cbor-unknown-hard-reject-sig-unsigned-v0` | `shipping-label-printing` | partial fit, likely negative-control value | partial fit, likely negative-control value | +0 |
...
| `SIM-vamaz-grid-envelope-enc-cbor-unknown-opaque-sig-mandatory-sig-pcid-payload` | `journalism-source-provenance` | strongest fit in this slice | strongest fit in this slice | +0 |
...
| `journalism-source-provenance` | 3.33 | 3.33 | +0.00 |
...
- This comparison is based on verdict text extracted from result artifacts, not executable protocol harness replay.
- Existing matrix rows now point to the latest `openai-gpt-5.3-codex-xhigh` run paths while baseline files remain in place under `openai-gpt-5.5-xhigh`.
