...
- 100-year durability: The BGP Routing pressure should still be understandable after tools, organizations,
...
`results/<sim-id>/bgp-routing/<model-id>/<YYYYMMDD-HHMMSS>.md`
