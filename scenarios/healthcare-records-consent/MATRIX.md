# Healthcare Records Consent Matrix
...
|---|---|---|---|---|
| `<candidate-sim-id>` | `healthcare-records-consent` |  | not-run | Replace with a real simulation ID when this application seed is run. |
