...
- Source row/title: Seed application catalog entry `agriculture-food-traceability`
- Source DI / TODO / TE: `DI-faros`; `DI-vabor`; `DI-botup`; `DI-midif`; `TODO-dadub`

## Purpose

Exercise PromiseGrid design candidates against agriculture-food-traceability application
pressure: Farm inputs, harvest lots, cold chain, inspections, recalls, and certification
evidence.
...
Alice depends on an outcome in the Agriculture Food Traceability domain. Bob makes
promises about farm inputs, harvest lots, cold chain, inspections, recalls, and
certification evidence. Carol needs enough evidence to rely on Bob's promise without
...
- 100-year durability: The Agriculture Food Traceability pressure should still be understandable after tools,
...
`results/<sim-id>/agriculture-food-traceability/<model-id>/<YYYYMMDD-HHMMSS>.md`
