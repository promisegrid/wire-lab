...
- 100-year durability: The State Governance pressure should still be understandable after tools, organizations,
...
`results/<sim-id>/state-governance/<model-id>/<YYYYMMDD-HHMMSS>.md`
