...
|---|---|---|---|---|
| `SIM-kohad-cas-object-type-binding-bakeoff` | `cas-object-type-binding-bakeoff-unknown-typed-object` |  | not-run | Source simulation for the mined row. |
