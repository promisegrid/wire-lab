...
- Source row/title: Seed application catalog entry `scientific-data-collaboration`
- Source DI / TODO / TE: `DI-faros`; `DI-vabor`; `DI-botup`; `DI-midif`; `TODO-dadub`

## Purpose

Exercise PromiseGrid design candidates against scientific-data-collaboration application
pressure: Dataset provenance, authorship, access promises, reproducibility, and
embargoes.
...
Alice depends on an outcome in the Scientific Data Collaboration domain. Bob makes
promises about dataset provenance, authorship, access promises, reproducibility, and
embargoes. Carol needs enough evidence to rely on Bob's promise without having complete
...
- 100-year durability: The Scientific Data Collaboration pressure should still be understandable after tools,
...
`results/<sim-id>/scientific-data-collaboration/<model-id>/<YYYYMMDD-HHMMSS>.md`
