...
- Source row/title: Seed application catalog entry `accounting`
- Source DI / TODO / TE: `DI-faros`; `DI-vabor`; `DI-botup`; `DI-midif`; `TODO-dadub`

## Purpose

Exercise PromiseGrid design candidates against accounting application pressure: Audit
trails, payment promises, reconciliations, corrections, and multi-party evidence.
...
Alice depends on an outcome in the Accounting domain. Bob makes promises about audit
trails, payment promises, reconciliations, corrections, and multi-party evidence. Carol
...
- 100-year durability: The Accounting pressure should still be understandable after tools, organizations,
...
`results/<sim-id>/accounting/<model-id>/<YYYYMMDD-HHMMSS>.md`
