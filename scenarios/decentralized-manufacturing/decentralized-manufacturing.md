...
- Source row/title: Seed application catalog entry `decentralized-manufacturing`
- Source DI / TODO / TE: `DI-faros`; `DI-vabor`; `DI-botup`; `DI-midif`; `TODO-dadub`

## Purpose

Exercise PromiseGrid design candidates against decentralized-manufacturing application
pressure: Distributed fabrication, machine capability claims, quality evidence, and
local fulfillment.
...
Alice depends on an outcome in the Decentralized Manufacturing domain. Bob makes
promises about distributed fabrication, machine capability claims, quality evidence, and
local fulfillment. Carol needs enough evidence to rely on Bob's promise without having
...
- 100-year durability: The Decentralized Manufacturing pressure should still be understandable after tools,
...
`results/<sim-id>/decentralized-manufacturing/<model-id>/<YYYYMMDD-HHMMSS>.md`
