...
- Primary source simulation: `SIM-gobaz-chunking-identity-bakeoff/`
- Other simulations that claim to address `chunking-identity-bakeoff` or the same PromiseGrid
...
`results/<sim-id>/chunking-identity-bakeoff-same-bytes-different-chunkers/<model-id>/<YYYYMMDD-HHMMSS>.md`
