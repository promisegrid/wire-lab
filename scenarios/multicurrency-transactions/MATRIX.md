# Multicurrency Transactions Matrix
...
|---|---|---|---|---|
| `<candidate-sim-id>` | `multicurrency-transactions` |  | not-run | Replace with a real simulation ID when this application seed is run. |
