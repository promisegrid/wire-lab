...
- 100-year durability: The Aerospace Development pressure should still be understandable after tools,
...
`results/<sim-id>/aerospace-development/<model-id>/<YYYYMMDD-HHMMSS>.md`
