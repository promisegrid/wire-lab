...
- Source row/title: Seed application catalog entry `municipal-governance`
- Source DI / TODO / TE: `DI-faros`; `DI-vabor`; `DI-botup`; `DI-midif`; `TODO-dadub`

## Purpose

Exercise PromiseGrid design candidates against municipal-governance application
pressure: Local ordinances, service requests, permits, budgets, public records, and
...
Alice depends on an outcome in the Municipal Governance domain. Bob makes promises about
local ordinances, service requests, permits, budgets, public records, and citizen
participation. Carol needs enough evidence to rely on Bob's promise without having
...
- 100-year durability: The Municipal Governance pressure should still be understandable after tools,
...
`results/<sim-id>/municipal-governance/<model-id>/<YYYYMMDD-HHMMSS>.md`
