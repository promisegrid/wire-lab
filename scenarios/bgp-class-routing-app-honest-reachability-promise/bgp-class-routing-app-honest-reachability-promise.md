...
- Primary source simulation: `SIM-punaz-bgp-class-routing-app/`
- Other simulations that claim to address `bgp-class-routing-app` or the same PromiseGrid
...
`results/<sim-id>/bgp-class-routing-app-honest-reachability-promise/<model-id>/<YYYYMMDD-HHMMSS>.md`
