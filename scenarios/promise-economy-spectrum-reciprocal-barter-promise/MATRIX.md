# Reciprocal barter promise Matrix
...
|---|---|---|---|---|
| `SIM-haros-promise-economy-spectrum` | `promise-economy-spectrum-reciprocal-barter-promise` |  | not-run | Source simulation for the mined row. |
