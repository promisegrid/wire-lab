...
| `SIM-nipoh-grid-envelope-enc-dag-cbor-unknown-hard-reject-sig-wrapper-pcid` | `chunking-identity-bakeoff-profile-negotiation-mismatch` | `results/SIM-nipoh-grid-envelope-enc-dag-cbor-unknown-hard-reject-sig-wrapper-pcid/chunking-identity-bakeoff-profile-negotiation-mismatch/openai-gpt-5.3-codex-xhigh/20260519-030134.md` | run | partial: Fails closed on unknown profile pCIDs; no chunker negotiation semantics. |
