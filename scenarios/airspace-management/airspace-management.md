...
- Source row/title: Seed application catalog entry `airspace-management`
- Source DI / TODO / TE: `DI-faros`; `DI-vabor`; `DI-botup`; `DI-midif`; `TODO-dadub`

## Purpose

Exercise PromiseGrid design candidates against airspace-management application pressure:
Airspace reservations, restrictions, deconfliction, notices, and multi-authority
coordination.
...
Alice depends on an outcome in the Airspace Management domain. Bob makes promises about
airspace reservations, restrictions, deconfliction, notices, and multi-authority
coordination. Carol needs enough evidence to rely on Bob's promise without having
...
- 100-year durability: The Airspace Management pressure should still be understandable after tools,
...
`results/<sim-id>/airspace-management/<model-id>/<YYYYMMDD-HHMMSS>.md`
