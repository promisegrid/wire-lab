...
- 100-year durability: The Emergency Communications pressure should still be understandable after tools,
...
`results/<sim-id>/emergency-communications/<model-id>/<YYYYMMDD-HHMMSS>.md`
