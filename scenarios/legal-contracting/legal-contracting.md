...
- 100-year durability: The Legal Contracting pressure should still be understandable after tools,
...
`results/<sim-id>/legal-contracting/<model-id>/<YYYYMMDD-HHMMSS>.md`
