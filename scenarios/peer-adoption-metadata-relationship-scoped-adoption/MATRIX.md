# Relationship-scoped adoption Matrix
...
|---|---|---|---|---|
| `SIM-dihiz-peer-adoption-metadata` | `peer-adoption-metadata-relationship-scoped-adoption` |  | not-run | Source simulation for the mined row. |
