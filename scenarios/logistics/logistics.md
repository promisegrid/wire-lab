...
- Source row/title: Seed application catalog entry `logistics`
- Source DI / TODO / TE: `DI-faros`; `DI-vabor`; `DI-botup`; `DI-midif`; `TODO-dadub`

## Purpose

Exercise PromiseGrid design candidates against logistics application pressure: Routing,
custody, capacity, exceptions, proof of delivery, and multi-carrier coordination.
...
Alice depends on an outcome in the Logistics domain. Bob makes promises about routing,
custody, capacity, exceptions, proof of delivery, and multi-carrier coordination. Carol
...
- 100-year durability: The Logistics pressure should still be understandable after tools, organizations,
...
`results/<sim-id>/logistics/<model-id>/<YYYYMMDD-HHMMSS>.md`
