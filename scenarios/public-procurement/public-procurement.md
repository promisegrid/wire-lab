...
- Source row/title: Seed application catalog entry `public-procurement`
- Source DI / TODO / TE: `DI-faros`; `DI-vabor`; `DI-botup`; `DI-midif`; `TODO-dadub`

## Purpose

Exercise PromiseGrid design candidates against public-procurement application pressure:
Solicitations, bids, award promises, delivery evidence, conflict-of-interest checks, and
auditability.
...
Alice depends on an outcome in the Public Procurement domain. Bob makes promises about
solicitations, bids, award promises, delivery evidence, conflict-of-interest checks, and
auditability. Carol needs enough evidence to rely on Bob's promise without having
...
- 100-year durability: The Public Procurement pressure should still be understandable after tools,
...
`results/<sim-id>/public-procurement/<model-id>/<YYYYMMDD-HHMMSS>.md`
