...
- Source row/title: Seed application catalog entry `housing-coop-management`
- Source DI / TODO / TE: `DI-faros`; `DI-vabor`; `DI-botup`; `DI-midif`; `TODO-dadub`

## Purpose

Exercise PromiseGrid design candidates against housing-coop-management application
pressure: Membership, dues, maintenance obligations, governance, disputes, and shared-
resource access.
...
Alice depends on an outcome in the Housing Coop Management domain. Bob makes promises
about membership, dues, maintenance obligations, governance, disputes, and shared-
resource access. Carol needs enough evidence to rely on Bob's promise without having
...
- 100-year durability: The Housing Coop Management pressure should still be understandable after tools,
...
`results/<sim-id>/housing-coop-management/<model-id>/<YYYYMMDD-HHMMSS>.md`
