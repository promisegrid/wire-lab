...
- 100-year durability: The Aviation Flight Planning pressure should still be understandable after tools,
...
`results/<sim-id>/aviation-flight-planning/<model-id>/<YYYYMMDD-HHMMSS>.md`
