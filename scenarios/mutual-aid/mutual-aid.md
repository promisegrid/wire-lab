...
- 100-year durability: The Mutual Aid pressure should still be understandable after tools, organizations,
...
`results/<sim-id>/mutual-aid/<model-id>/<YYYYMMDD-HHMMSS>.md`
