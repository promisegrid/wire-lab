...
- 100-year durability: The Aerospace Design pressure should still be understandable after tools, organizations,
...
`results/<sim-id>/aerospace-design/<model-id>/<YYYYMMDD-HHMMSS>.md`
