...
- 100-year durability: The Open Source Development pressure should still be understandable after tools,
...
`results/<sim-id>/open-source-development/<model-id>/<YYYYMMDD-HHMMSS>.md`
