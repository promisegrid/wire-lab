...
- Source row/title: Seed application catalog entry `energy-grid-coordination`
- Source DI / TODO / TE: `DI-faros`; `DI-vabor`; `DI-botup`; `DI-midif`; `TODO-dadub`

## Purpose

Exercise PromiseGrid design candidates against energy-grid-coordination application
pressure: Generation/load promises, demand response, outage repair, safety constraints,
and market signals.
...
Alice depends on an outcome in the Energy Grid Coordination domain. Bob makes promises
about generation/load promises, demand response, outage repair, safety constraints, and
market signals. Carol needs enough evidence to rely on Bob's promise without having
...
- 100-year durability: The Energy Grid Coordination pressure should still be understandable after tools,
...
`results/<sim-id>/energy-grid-coordination/<model-id>/<YYYYMMDD-HHMMSS>.md`
