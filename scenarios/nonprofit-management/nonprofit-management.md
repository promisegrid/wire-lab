...
- Source row/title: Seed application catalog entry `nonprofit-management`
- Source DI / TODO / TE: `DI-faros`; `DI-vabor`; `DI-botup`; `DI-midif`; `TODO-dadub`

## Purpose

Exercise PromiseGrid design candidates against nonprofit-management application
pressure: Donations, restricted funds, volunteers, governance, program delivery, and
...
Alice depends on an outcome in the Nonprofit Management domain. Bob makes promises about
donations, restricted funds, volunteers, governance, program delivery, and public
...
- 100-year durability: The Nonprofit Management pressure should still be understandable after tools,
...
`results/<sim-id>/nonprofit-management/<model-id>/<YYYYMMDD-HHMMSS>.md`
