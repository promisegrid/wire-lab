...
- Source row/title: Seed application catalog entry `aerospace-project-funding`
- Source DI / TODO / TE: `DI-faros`; `DI-vabor`; `DI-botup`; `DI-midif`; `TODO-dadub`

## Purpose

Exercise PromiseGrid design candidates against aerospace-project-funding application
pressure: Milestone funding, investor/grantor promises, deliverable evidence, and
...
Alice depends on an outcome in the Aerospace Project Funding domain. Bob makes promises
about milestone funding, investor/grantor promises, deliverable evidence, and governance
under uncertainty. Carol needs enough evidence to rely on Bob's promise without having
...
- 100-year durability: The Aerospace Project Funding pressure should still be understandable after tools,
...
`results/<sim-id>/aerospace-project-funding/<model-id>/<YYYYMMDD-HHMMSS>.md`
