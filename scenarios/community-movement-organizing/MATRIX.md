# Community Movement Organizing Matrix
...
|---|---|---|---|---|
| `<candidate-sim-id>` | `community-movement-organizing` |  | not-run | Replace with a real simulation ID when this application seed is run. |
