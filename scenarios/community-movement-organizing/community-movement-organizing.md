...
- 100-year durability: The Community Movement Organizing pressure should still be understandable after tools,
...
`results/<sim-id>/community-movement-organizing/<model-id>/<YYYYMMDD-HHMMSS>.md`
