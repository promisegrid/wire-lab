...
- Source row/title: Seed application catalog entry `personal-currencies`
- Source DI / TODO / TE: `DI-faros`; `DI-vabor`; `DI-botup`; `DI-midif`; `TODO-dadub`

## Purpose

Exercise PromiseGrid design candidates against personal-currencies application pressure:
Peer-issued value, local exchange rates, default history, trust portability, and
speculation failure.
...
Alice depends on an outcome in the Personal Currencies domain. Bob makes promises about
peer-issued value, local exchange rates, default history, trust portability, and
speculation failure. Carol needs enough evidence to rely on Bob's promise without having
...
- 100-year durability: The Personal Currencies pressure should still be understandable after tools,
...
`results/<sim-id>/personal-currencies/<model-id>/<YYYYMMDD-HHMMSS>.md`
