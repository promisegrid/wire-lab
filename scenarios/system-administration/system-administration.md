...
- Source row/title: Seed application catalog entry `system-administration`
- Source DI / TODO / TE: `DI-faros`; `DI-vabor`; `DI-botup`; `DI-midif`; `TODO-dadub`

## Purpose

Exercise PromiseGrid design candidates against system-administration application
pressure: User accounts, configuration drift, backups, patching, access review, and
...
Alice depends on an outcome in the System Administration domain. Bob makes promises
about user accounts, configuration drift, backups, patching, access review, and break-
glass authority. Carol needs enough evidence to rely on Bob's promise without having
...
- 100-year durability: The System Administration pressure should still be understandable after tools,
...
`results/<sim-id>/system-administration/<model-id>/<YYYYMMDD-HHMMSS>.md`
