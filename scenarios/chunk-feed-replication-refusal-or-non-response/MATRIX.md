# Refusal or non-response Matrix
...
|---|---|---|---|---|
| `SIM-zazit-chunk-feed-replication` | `chunk-feed-replication-refusal-or-non-response` |  | not-run | Source simulation for the mined row. |
