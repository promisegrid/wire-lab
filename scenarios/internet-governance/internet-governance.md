...
- Source row/title: Seed application catalog entry `internet-governance`
- Source DI / TODO / TE: `DI-faros`; `DI-vabor`; `DI-botup`; `DI-midif`; `TODO-dadub`

## Purpose

Exercise PromiseGrid design candidates against internet-governance application pressure:
Protocol evolution, registry-like pressure, multi-stakeholder legitimacy, and schism
resilience.
...
Alice depends on an outcome in the Internet Governance domain. Bob makes promises about
protocol evolution, registry-like pressure, multi-stakeholder legitimacy, and schism
resilience. Carol needs enough evidence to rely on Bob's promise without having complete
...
- 100-year durability: The Internet Governance pressure should still be understandable after tools,
...
`results/<sim-id>/internet-governance/<model-id>/<YYYYMMDD-HHMMSS>.md`
