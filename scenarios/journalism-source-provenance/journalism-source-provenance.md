...
- Source row/title: Seed application catalog entry `journalism-source-provenance`
- Source DI / TODO / TE: `DI-faros`; `DI-vabor`; `DI-botup`; `DI-midif`; `TODO-dadub`

## Purpose

Exercise PromiseGrid design candidates against journalism-source-provenance application
pressure: Source protection, evidence chains, publication promises, corrections, and
...
Alice depends on an outcome in the Journalism Source Provenance domain. Bob makes
promises about source protection, evidence chains, publication promises, corrections,
and adversarial disinformation. Carol needs enough evidence to rely on Bob's promise
...
- 100-year durability: The Journalism Source Provenance pressure should still be understandable after tools,
...
`results/<sim-id>/journalism-source-provenance/<model-id>/<YYYYMMDD-HHMMSS>.md`
