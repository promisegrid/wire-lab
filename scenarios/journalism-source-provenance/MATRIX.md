...
|---|---|---|---|---|
| `SIM-kovis-grid-envelope-enc-cbor-unknown-hard-reject-sig-mandatory-sig-pcid-payload` | `journalism-source-provenance` | `results/SIM-kovis-grid-envelope-enc-cbor-unknown-hard-reject-sig-mandatory-sig-pcid-payload/journalism-source-provenance/openai-gpt-5.3-codex-xhigh/20260519-025634.md` | run | partial brittle: Fail-closed source evidence; weak custody across handler gaps. |
