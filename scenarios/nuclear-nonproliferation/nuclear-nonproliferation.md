...
- Source row/title: Seed application catalog entry `nuclear-nonproliferation`
- Source DI / TODO / TE: `DI-faros`; `DI-vabor`; `DI-botup`; `DI-midif`; `TODO-dadub`

## Purpose

Exercise PromiseGrid design candidates against nuclear-nonproliferation application
pressure: High-stakes verification promises, inspection evidence, sanctions, and trust
under adversarial incentives.
...
Alice depends on an outcome in the Nuclear Nonproliferation domain. Bob makes promises
about high-stakes verification promises, inspection evidence, sanctions, and trust under
adversarial incentives. Carol needs enough evidence to rely on Bob's promise without
...
- 100-year durability: The Nuclear Nonproliferation pressure should still be understandable after tools,
...
`results/<sim-id>/nuclear-nonproliferation/<model-id>/<YYYYMMDD-HHMMSS>.md`
