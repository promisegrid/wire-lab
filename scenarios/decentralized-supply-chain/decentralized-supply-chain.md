...
- Source row/title: Seed application catalog entry `decentralized-supply-chain`
- Source DI / TODO / TE: `DI-faros`; `DI-vabor`; `DI-botup`; `DI-midif`; `TODO-dadub`

## Purpose

Exercise PromiseGrid design candidates against decentralized-supply-chain application
pressure: Supplier promises, provenance, substitutions, delays, recalls, and sparse
...
Alice depends on an outcome in the Decentralized Supply Chain domain. Bob makes promises
about supplier promises, provenance, substitutions, delays, recalls, and sparse
knowledge of the graph. Carol needs enough evidence to rely on Bob's promise without
...
- 100-year durability: The Decentralized Supply Chain pressure should still be understandable after tools,
...
`results/<sim-id>/decentralized-supply-chain/<model-id>/<YYYYMMDD-HHMMSS>.md`
