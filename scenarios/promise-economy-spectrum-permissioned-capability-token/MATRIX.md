# Permissioned capability token Matrix
...
|---|---|---|---|---|
| `SIM-haros-promise-economy-spectrum` | `promise-economy-spectrum-permissioned-capability-token` |  | not-run | Source simulation for the mined row. |
