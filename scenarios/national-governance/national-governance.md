...
- Source row/title: Seed application catalog entry `national-governance`
- Source DI / TODO / TE: `DI-faros`; `DI-vabor`; `DI-botup`; `DI-midif`; `TODO-dadub`

## Purpose

Exercise PromiseGrid design candidates against national-governance application pressure:
Large-scale public authority, federal records, procurement, identity, and checks against
capture.
...
Alice depends on an outcome in the National Governance domain. Bob makes promises about
large-scale public authority, federal records, procurement, identity, and checks against
capture. Carol needs enough evidence to rely on Bob's promise without having complete
...
- 100-year durability: The National Governance pressure should still be understandable after tools,
...
`results/<sim-id>/national-governance/<model-id>/<YYYYMMDD-HHMMSS>.md`
