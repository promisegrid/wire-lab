...
- 100-year durability: The Makerspace Door Access pressure should still be understandable after tools,
...
`results/<sim-id>/makerspace-door-access/<model-id>/<YYYYMMDD-HHMMSS>.md`
