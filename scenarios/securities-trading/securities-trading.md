...
- Source row/title: Seed application catalog entry `securities-trading`
- Source DI / TODO / TE: `DI-faros`; `DI-vabor`; `DI-botup`; `DI-midif`; `TODO-dadub`

## Purpose

Exercise PromiseGrid design candidates against securities-trading application pressure:
Orders, settlement, compliance evidence, counterparty risk, and market manipulation
pressure.
...
Alice depends on an outcome in the Securities Trading domain. Bob makes promises about
orders, settlement, compliance evidence, counterparty risk, and market manipulation
pressure. Carol needs enough evidence to rely on Bob's promise without having complete
...
- 100-year durability: The Securities Trading pressure should still be understandable after tools,
...
`results/<sim-id>/securities-trading/<model-id>/<YYYYMMDD-HHMMSS>.md`
