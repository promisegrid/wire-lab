...
- 100-year durability: The Climate Coordination pressure should still be understandable after tools,
...
`results/<sim-id>/climate-coordination/<model-id>/<YYYYMMDD-HHMMSS>.md`
