...
- Source row/title: Seed application catalog entry `healthcare-referrals`
- Source DI / TODO / TE: `DI-faros`; `DI-vabor`; `DI-botup`; `DI-midif`; `TODO-dadub`

## Purpose

Exercise PromiseGrid design candidates against healthcare-referrals application
pressure: Referral promises, consent, provider credentials, scheduling, and outcome
evidence.
...
Alice depends on an outcome in the Healthcare Referrals domain. Bob makes promises about
referral promises, consent, provider credentials, scheduling, and outcome evidence.
...
- 100-year durability: The Healthcare Referrals pressure should still be understandable after tools,
...
`results/<sim-id>/healthcare-referrals/<model-id>/<YYYYMMDD-HHMMSS>.md`
