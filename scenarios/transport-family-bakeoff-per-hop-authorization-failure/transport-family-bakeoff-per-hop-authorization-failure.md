...
- Primary source simulation: `SIM-narok-transport-family-bakeoff/`
- Other simulations that claim to address `transport-family-bakeoff` or the same PromiseGrid
...
`results/<sim-id>/transport-family-bakeoff-per-hop-authorization-failure/<model-id>/<YYYYMMDD-HHMMSS>.md`
