...
Snapshot generated by Codex on 2026-06-24 12:55 PDT. This is a
...
- `implementations/poc15-multihop-multiarity-dag/` is executable provisional
  ...
  implementation-local embedded markdown protocol specs from
  `implementations/poc16-secure-tokens-maps-encrypted-payloads/docs/protocols/`
  into pCIDs, injects spec excerpts into LLM prompt context, emits raw CBOR artifacts for map, secure capability,
  encrypted payload, and parser/builder profile pCIDs, and gates CWT-style
	  ...
	  Source: `DI-vulit`; `DI-magug`; `TODO-zugok`; `TE-ritig`.
