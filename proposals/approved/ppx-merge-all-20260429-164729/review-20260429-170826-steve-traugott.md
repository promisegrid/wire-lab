...
3. Merge proceeds despite missing inline DI/DR provenance in the touched `specs/harness-spec-draft.md` and TE docs, because follow-up work is already tracked in `TODO/005-te-promise-stack-ordering.md`, `TODO/006-backfill-di-provenance-harness-spec.md`, and `TODO/007-backfill-dr-harness-spec-section-11.md`.
