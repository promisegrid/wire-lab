...
- `TODO-11` (integer alias)
- `TODO-20260429-180020` (timestamp alias and pre-migration filename)
...
These were locked by Steve in chat 2026-04-29 before TE-rujak was written. They are inputs to TE-rujak, not under DF in TE-rujak itself:
...
- [ ] 011.10 After genesis freeze lands, open a follow-on TE on peer-level adoption metadata (the wire shape of "I, peer P, promise to behave as pCID X with open-question answers Q7=yes, Q9=variant-B"). This is the missing half of TE-nibar Alt-E that TE-rujak did not address. The protocol/specimen question is now captured as a standalone simulation question in `simulations/SIM-dihiz-peer-adoption-metadata/`, without answering or closing this subtask. Source: `DI-pukap`.
...
Linked DR: none (chat-directed lock); pre-cursor TE: TE-rujak.
...
Linked DR: none; pre-cursor TE: TE-rujak.
...
Linked DR: none; pre-cursor TE: TE-rujak DF-22.1.
...
Linked DR: none; pre-cursor TE: TE-rujak DF-22.2.
...
Linked DR: none; pre-cursor TE: TE-rujak DF-22.3.
...
Linked DR: none; pre-cursor TE: TE-rujak DF-22.4.
...
Linked DR: none; pre-cursor TE: TE-rujak DF-22.5.

## Notes

- TE-rujak carries the full alternative analysis (Alt-1.A-D, Alt-3.A-D, Alt-4.A-D, Alt-5.A-D) and six scenarios (S1-S6). This file does not duplicate that analysis; it tracks the decision-driving work.
