...
- `TODO-4` (integer alias)
- `TODO-20260429-163909` (timestamp alias and pre-migration filename)
...
Affects: `specs/harness-spec-draft.md`; `docs/thought-experiments/TE-famar-promise-stack-ordering.md`; `docs/thought-experiments/TE-botom-harness-spec-change-walks-through-unified-flow.md`; `docs/thought-experiments/TE-dodaf-should-this-design-become-promisegrid-readme.md`.
