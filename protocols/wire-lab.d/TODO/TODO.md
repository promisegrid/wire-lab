...
| [TODO-godad](./TODO-godad-poc13-cas-compute-functions.md) | 2026-06-06 | POC13 CAS storage and CID-named compute functions **(implemented: TCP-delivered CAS/compute runtime with readiness/done, TCP-level Bob outage, Frank-issued replica tokens, adversarial compute rejection, evidence pCID routing, unknown-pCID and unsupported-variant non-commitment, capacity pressure, narrative docs, and archived analyzer score/report output)** | — |
