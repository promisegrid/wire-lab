...
| [TODO-nahop](./TODO-nahop-poc18-cas-git-replacement.md) | 2026-06-25 | POC18 CAS-backed Git replacement **(planned: POC16 superset using Rabin-chunked CAS object storage, all POSIX inode types, grid-envelope parent links, versioned reference sets, continuous peer DAG sync instead of native push/pull, completed Tangled/architecture review, RFC-like `version-control.md` pCID spec, and Git bridge import/export/push/pull)** | — |
