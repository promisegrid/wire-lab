...
| [TODO-komon](./TODO-komon-poc17-m4-lora-runtime.md) | 2026-06-16 | POC17 M4 LoRa runtime **(Go behavior simulator active: constrained Cortex-M4/LoRa-shaped agent, radio-only PromiseGrid traffic, bintags-shaped order status, host-local lifecycle tokens, explicit resource limits, and capability-gated peer_storage put/get recovery)** | — |
| [TODO-nahop](./TODO-nahop-poc18-cas-git-replacement.md) | 2026-06-25 | POC18 CAS-backed Git replacement **(planned: POC16 superset using CAS object storage, restic chunking, grid-envelope parent links, versioned reference sets, continuous peer DAG sync instead of native push/pull, Tangled prior-art review, and Git roundtrip)** | — |
