# TODO 006 - Backfill DI provenance into harness-spec.md settled statements
...
- This work is a quality/provenance backfill, not a new design decision. Existing semantics in `harness-spec.md` are not changed.
