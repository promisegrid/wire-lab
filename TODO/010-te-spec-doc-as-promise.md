...
- [ ] 010.4 Steve answers DF-21.4 (does this TE imply rename or restructure of `harness-spec.md`). Recommended: 4.a (no, defer to TE-22).
- [ ] 010.5 Once 010.1-010.4 land, write a DI for each into this file.
- [ ] 010.6 If 010.2 lands as 2.a (required), update `harness-spec.md` to add or formalize the three normative sections: Assumptions, Open Questions (already present as \u00a711), Known Issues. Cross-link them to TE-21 and the relevant DI(s).
