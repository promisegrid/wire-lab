# TODO 012 - Repo-local channel carrier via `grid <pcid>`
...
- [x] 012.2 Lock the repo-local `channels/` carrier decision in a Decision Intent record.
- [x] 012.3 Write a long-form report and v0 contract in `channels/README.md`.
- [x] 012.4 Add the TE to `docs/thought-experiments/README.md`.
- [x] 012.5 Update `specs/harness-spec-draft.md` with a TE summary and a canonical open question about whether the repo-local carrier should graduate into the canonical wire format.
- [ ] 012.6 Create per-direction channel subdirectories only after the v0 contract has been reviewed and future message traffic justifies the extra structure.
...
Affects: `TODO/TODO.md`; `TODO/012-grid-pcid-channel-carrier.md`; `DR/DR-009-20260430-204108-grid-pcid-channel-carrier.md`; `docs/thought-experiments/TE-20260430-204108-grid-pcid-channel-carrier.md`; `docs/thought-experiments/README.md`; `specs/harness-spec-draft.md`; `channels/README.md`; future repo-local channel messages between Codex and Perplexity.
