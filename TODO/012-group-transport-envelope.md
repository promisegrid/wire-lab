...
- [ ] 012.7 First real round-trip on the codex-perplexity instance: at least two messages exchanged, exercising §3 (CID computation), §4 (envelope), §4.6 (`Parents:` DAG link), §6 (body-as-receipt), and §7 (append-only) of `specs/group-transport-draft.md`.
- [ ] 012.8 Freeze `specs/transport-spec-draft.md` (outer rule) and `specs/group-transport-draft.md` (substantive contract) once 012.7 produces enough on-disk artifacts to validate the v0 envelope.
...
- The TODO 013 carve-out (separate file `TODO/013-transports-carveout.md`) split the original combined "channels/" material into the outer transport-spec, the group-transport spec, and this updated TODO. See TODO 013 for the carve-out details.
