...
Affects: `channels/README.md`; future `channels/*` artifacts; `TODO/012-grid-pcid-channel-carrier.md`; `docs/thought-experiments/TE-20260430-204108-grid-pcid-channel-carrier.md`; `specs/harness-spec-draft.md` references to the thought experiment and its remaining open question.
...
- `DI-009-20260430-204108` in `TODO/012-grid-pcid-channel-carrier.md`
