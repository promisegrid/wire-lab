...
| `SIM-haros-promise-economy-spectrum/` | Turn-179 standalone exploration for promise-economy mechanism neutrality across peer-local assessment, capability tokens, transferability, floating rates, and cryptocurrency-toxicity failure modes. Source: `DI-vabij`. | Active design-point exploration |
