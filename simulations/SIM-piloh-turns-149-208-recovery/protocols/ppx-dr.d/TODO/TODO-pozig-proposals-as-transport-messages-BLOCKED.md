...
- `TODO-16` (integer alias)
- `TODO-20260501-230131` (timestamp alias and pre-migration filename)
...
Simulation note: this TODO moved with the `ppx-dr` protocol specimen into
`simulations/SIM-piloh-turns-149-208-recovery/protocols/ppx-dr.d/` per
`DI-fakin`. Its original goal remains historical design evidence. The legacy
`proposals/` records now live in this simulation's `archive/proposals/`, and
the active guide-writer discovery path is `DEV-GUIDE-RESOURCES.md`.
