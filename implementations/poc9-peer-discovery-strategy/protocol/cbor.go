...
// cborWriter writes the deterministic CBOR subset POC9 needs.
// Intent: Exercise real byte-level CBOR grid envelopes without pulling in a
// broad dependency or making the POC about codec library selection. Source: DI-fibok
...
// Intent: Keep POC9 payloads protocol-owned and byte-signable while avoiding
// JSON canonicalization problems. Source: DI-fibok
...
// cborReader reads the deterministic CBOR subset POC9 writes.
