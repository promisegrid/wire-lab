...
// cborWriter writes the small deterministic CBOR subset needed by poc5.
// Intent: Keep poc5 focused on PromiseGrid message behavior while preserving
// the current grid([42(pCID), payload, ...]) wire shape. Source: DI-rarim.
...
// MarshalStringMap encodes POC payload fields deterministically.
...
// cborReader reads the same POC CBOR subset.
...
// UnmarshalStringMap decodes deterministic POC payload fields.
