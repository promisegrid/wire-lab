...
// Intent: POC16 correlates strong local trust with direct TCP adjacency and
...
func (ledger *Ledger) ObserveOutcome(peerName string, outcome Outcome) Transition {
	...
	case OutcomeDiscoveryKept:
		...
		// because the strong-trust threshold is deliberately small in POC16.
...
// Intent: POC16 monitor output should not show unbounded local trust values
