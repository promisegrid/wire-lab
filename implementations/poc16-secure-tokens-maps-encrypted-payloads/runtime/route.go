...
const poc16RouteID = "route-alice-bob-carol-dave-0001"
const poc16RoutePath = "alice>bob>carol>dave"
const poc16RouteResponsePath = "dave>carol>bob>alice"
const poc16PeggyRouteID = "route-alice-dave-peggy-0001"
const poc16PeggyRoutePath = "alice>dave>peggy"
const poc16VictorRouteID = "route-alice-dave-victor-0001"
const poc16VictorRoutePath = "alice>dave>victor"
...
func primaryRouteSpec() routeSpec {
	return routeSpec{
		...
		TTLMessages:  "2",
		ResponsePath: poc16RouteResponsePath,
	}
}
...
// runRoutePromiseWorkflow exercises the first executable POC16 multi-hop route.
...
func (node *Node) runRoutePromiseWorkflow() error {
	...
	if err := node.runRoutedRuntimeComputeWorkflow("peggy", runtimeRouteSpec(poc16PeggyRouteID, poc16PeggyRoutePath, "peggy")); err != nil {
		return err
	}
	return node.runRoutedRuntimeComputeWorkflow("victor", runtimeRouteSpec(poc16VictorRouteID, poc16VictorRoutePath, "victor"))
}
