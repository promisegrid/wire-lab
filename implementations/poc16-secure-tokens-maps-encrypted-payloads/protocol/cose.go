...
// COSESign1 is the parsed subset of COSE_Sign1 that POC16 needs for envelope
// shape pressure tests.
// Intent: POC16 should test COSE as a protocol-owned payload/proof option while
...
// VerifyCOSESign1 checks the POC16 COSE_Sign1 subset and requires protected
...
func parseCOSESign1(coseBytes []byte) (COSESign1, error) {
	...
	if unprotectedLength != 0 {
		return COSESign1{}, fmt.Errorf("POC16 COSE_Sign1 unprotected header must be empty")
	}
