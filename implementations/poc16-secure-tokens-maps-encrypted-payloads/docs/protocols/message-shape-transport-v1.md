...
message_shape_transport_v1 specifies one concrete envelope arity specimen: `grid([42(pCID), payload])`. It exists so
...
```text
[start] --payload carried under authenticated session--> [receiver interprets payload]
