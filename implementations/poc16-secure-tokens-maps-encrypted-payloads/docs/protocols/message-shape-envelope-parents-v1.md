# message_shape_envelope_parents_v1
...
message_shape_envelope_parents_v1 specifies one concrete envelope arity specimen: `grid([42(pCID), parents, payload, proof])`. It exists so
...
```text
[parent known] --message links parent in slot 1--> [DAG edge visible before payload parse]
