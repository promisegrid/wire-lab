...
message_shape_cose_payload_v1 specifies one concrete envelope arity specimen: `grid([42(pCID), COSE_Sign1])`. It exists so
...
```text
[COSE object received] --COSE signature verified--> [embedded payload accepted]
