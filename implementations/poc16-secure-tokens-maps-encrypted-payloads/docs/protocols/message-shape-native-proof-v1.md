...
message_shape_native_proof_v1 specifies one concrete envelope arity specimen: `grid([42(pCID), payload, proof])`. It exists so
...
```text
[payload built] --native proof verified--> [payload accepted locally]
