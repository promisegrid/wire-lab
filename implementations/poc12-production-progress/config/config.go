...
// Config is the repo-local, non-secret runtime configuration for POC12.
...
// Load reads and validates a POC12 config file.
...
// Validate checks that the config is complete enough for a bounded POC12 run.
