...
// Intent: POC12 must not import or shell out to ga-runner; this client is
...
// Intent: Use provider schema enforcement without changing the POC12 protocol
...
func (client LiveClient) Evaluate(ctx context.Context, events []Event) (MonitorReport, error) {
	...
	userPrompt := "Evaluate this POC12 run as an observer only. Return exactly one JSON object matching " +
