...
// cborWriter writes the deterministic CBOR subset POC11 needs.
// Intent: Exercise real byte-level CBOR grid envelopes without making this POC
// depend on a broad codec stack. Source: DI-hotos
...
// cborReader reads the deterministic CBOR subset POC11 writes.
