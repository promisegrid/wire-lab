...
// cborWriter writes the deterministic CBOR subset POC7 needs.
...
// Intent: Keep POC7 payloads protocol-owned and byte-signable while avoiding
...
// cborReader reads the deterministic CBOR subset POC7 writes.
