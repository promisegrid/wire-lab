...
// Intent: POC13 avoids real USB dependencies while still making hardware access
...
// Intent: POC13 preserves the distinction between pCID protocol identity and
...
// Intent: POC13 tests CID-named arbitrary function bytes without embedding a
