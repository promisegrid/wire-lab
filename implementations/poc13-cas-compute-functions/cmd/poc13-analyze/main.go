...
// RunSummary is the deterministic JSON report emitted by poc13-analyze.
// Intent: Keep POC13 live runs comparable without committing provider logs or
...
// ScoreReport gives the operator a fast POC13 fitness view in addition to the
// raw event counters.
...
// analyzeRun summarizes one POC13 run directory containing agent JSONL files and
...
// validateSummary checks the POC13 clean-run evidence gates without mutating
