...
// Intent: POC15 must not import or shell out to ga-runner; this client is
...
// Intent: Use provider schema enforcement without changing the POC15 protocol
...
func (client LiveClient) Evaluate(ctx context.Context, events []Event) (MonitorReport, error) {
	...
	userPrompt := "Evaluate this POC15 run as an observer only. Return exactly one JSON object matching " +
...
func monitorSystemPrompt() string {
	// Intent: POC15 deliberately includes malformed, adversarial, replay, and
