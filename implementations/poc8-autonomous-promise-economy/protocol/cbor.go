...
// cborWriter writes the deterministic CBOR subset POC8 needs.
...
// Intent: Keep POC8 payloads protocol-owned and byte-signable while avoiding
...
// cborReader reads the deterministic CBOR subset POC8 writes.
