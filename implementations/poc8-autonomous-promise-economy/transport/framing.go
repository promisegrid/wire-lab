...
// FrameConn carries one signed POC8 envelope per length-prefixed TCP frame.
// Intent: Keep transport as boring TCP plumbing while the semantic message
// remains the pCID-selected CBOR grid envelope. Source: DI-tanat
