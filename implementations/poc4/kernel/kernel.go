...
//
// Intent: In poc4, relays own neighbor transport. The kernel stays a local
// promise boundary rather than a multi-hop router. Source: DI-bigub.
type Kernel struct {
	NodeName           string
	AppListen          string
