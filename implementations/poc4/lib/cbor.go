...
// cborWriter writes the small deterministic CBOR subset needed by poc4.
// Intent: Keep poc4 focused on PromiseGrid message behavior while preserving
// the current grid([42(pCID), payload, ...]) wire shape. Source: DI-bigub.
