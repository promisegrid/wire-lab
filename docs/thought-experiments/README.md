...
| [TE-mupoz](TE-mupoz-root-protocol-migration-scope-under-simulations.md) | 2026-05-10 | Root and protocol migration scope under simulations `(decided: DI-pakid, DI-fakin)` |  |
| [TE-david](TE-david-promisegrid-dev-guide-resources.md) | 2026-05-08 | PromiseGrid dev-guide resources from wire-lab evidence |  |
| [TE-dojab](TE-dojab-simulation-run-model-and-scenario-result-matrix.md) | 2026-05-19 | Simulation run model and scenario/result matrix |  |
...
| [TE-mazop](TE-mazop-kernel-promise-boundary-and-minimum-port-contract.md) | 2026-05-25 | Kernel promise boundary and minimum port contract |  |
| [TE-pudiv](TE-pudiv-app-kernel-grid-message-boundary.md) | 2026-05-25 | App/kernel grid message boundary |  |
| [TE-dunas](TE-dunas-prior-art-influence-on-promisegrid-kernel.md) | 2026-05-25 | Prior-art influence on the PromiseGrid kernel |  |
| [TE-gakoh](TE-gakoh-local-views-over-promise-event-hypergraph.md) | 2026-05-25 | Local views over a promise/event hypergraph |  |
| [TE-ritig](TE-ritig-pcid-cardinality-parser-builder-kernel-roles.md) | 2026-06-19 | pCID cardinality and parser/builder kernel roles |  |
| [TE-ragin](TE-ragin-kernel-resource-protection-capability-promises.md) | 2026-06-25 | Kernel resource protection by conditional capability promises |  |
| [TE-vahoj](TE-vahoj-poc18-superset-architecture.md) | 2026-06-28 | POC18 superset architecture |  |
| [TE-hikar](TE-hikar-poc18-grid-cli-command-model.md) | 2026-06-28 | POC18 grid CLI command model |  |
| [TE-givul](TE-givul-poc18-chunk-storage-identity.md) | 2026-06-28 | POC18 chunk storage identity |  |
| [TE-nozal](TE-nozal-dag-cbor-role-in-promisegrid.md) | 2026-06-29 | DAG-CBOR role in PromiseGrid |  |
