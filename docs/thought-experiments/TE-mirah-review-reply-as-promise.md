...
- `TE-17` (integer alias)
- `TE-20260429-162212` (timestamp alias and pre-migration filename)
...
- Lock the semantic correction in `DI-003-20260429-162212` under `protocols/wire-lab.d/TODO/TODO-kavug-review-reply-as-promise.md`.
