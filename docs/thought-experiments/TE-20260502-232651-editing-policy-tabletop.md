...
`partially decided` — DF-35.1 answered Alt-1.C on 2026-05-02 (bot recommendation under Steve's `make a recommendation` directive); DI-020-20260502-232651 in TODO 020 supersedes DI-020-20260502-213103's Cat-1 clause, splitting Cat-1 into Cat-1a (current-pointer, swept) and Cat-1b (historical-quotation, left). DF-35.2 answered Alt-2.a on 2026-05-02 (same directive); recorded as a Cat-3 procedural Refinement on TE-34 mandating that Cat-2 top-of-file notes enumerate unchanged DIs by ID (no separate DI). DF-35.3 answered Alt-3.a on 2026-05-02 (same directive); recorded as a Cat-3 procedural Refinement on TE-34 mandating a corpus-wide grep for old-term-in-quotation contexts before any Cat-2 sweep, with Cat-2 / Cat-2-historical classification per match (no separate DI). DF-35.4 remains pending. The locked decisions from TE-34 (DI-020-20260502-213104 / -213105 plus the residual Cat-3/4/5/6/7 clauses of -213103) remain in force.
