...
- `TE-16` (integer alias)
- `TE-20260429-033208` (timestamp alias and pre-migration filename)
...
- Lock the decision in `DI-002-20260429-033208` under `protocols/wire-lab.d/TODO/TODO-fofas-review-feedback-as-contest-artifact.md`.
