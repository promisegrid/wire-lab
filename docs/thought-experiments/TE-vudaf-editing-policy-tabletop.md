...
`decided` — all four DFs answered on 2026-05-02 (bot recommendations under Steve's `make a recommendation` directive). DF-35.1 -> Alt-1.C: DI-020-20260502-232651 in TODO 020 supersedes DI-020-20260502-213103's Cat-1 clause, splitting Cat-1 into Cat-1a (current-pointer, swept) and Cat-1b (historical-quotation, left). DF-35.2 -> Alt-2.a: Cat-3 procedural Refinement on TE-34 mandating that Cat-2 top-of-file notes enumerate unchanged DIs by ID. DF-35.3 -> Alt-3.a: Cat-3 procedural Refinement on TE-34 mandating a corpus-wide grep for old-term-in-quotation contexts before any Cat-2 sweep. DF-35.4 -> Alt-4.a: Cat-3 procedural Refinement on TE-34 adding a top-of-file `Status:` header field across the corpus; retrofit sweep is subtask 020.10 (Cat-1a, ready to execute). The locked decisions from TE-34 (DI-020-20260502-213104 / -213105 plus the residual Cat-3/4/5/6/7 clauses of -213103) remain in force. Subtasks 020.5 / 020.6 / 020.7 / 020.10 are now all unblocked.
