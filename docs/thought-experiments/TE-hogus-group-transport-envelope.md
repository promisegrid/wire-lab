# TE-hogus: Group-transport envelope: `grid <pcid>` carrier, canonical bytes, and explicit promise body
...
- `TE-24` (integer alias)
- `TE-20260430-204108` (timestamp alias and pre-migration filename)
