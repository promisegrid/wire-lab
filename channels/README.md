...
The thought experiment behind this choice lives in `docs/thought-experiments/TE-20260430-204108-grid-pcid-channel-carrier.md`. The decision request is `DR/DR-009-20260430-204108-grid-pcid-channel-carrier.md`. The lock record is in `TODO/009-grid-pcid-channel-carrier.md`.
...
- `TE-21` (`docs/thought-experiments/TE-20260430-204108-grid-pcid-channel-carrier.md`) is the direct comparison of the channel-carrier alternatives and is the immediate rationale for the current v0 decision.
